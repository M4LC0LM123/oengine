...
impl_NewList: proc "c" (list: uint, mode: Enum)
impl_EndList: proc "c" ()
impl_CallList: proc "c" (list: uint)
impl_CallLists: proc "c" (n: sizei, type: Enum, lists: rawptr)
impl_DeleteLists: proc "c" (list: uint, range: sizei)
impl_GenLists: proc "c" (range: sizei) -> uint
impl_ListBase: proc "c" (base: uint)
impl_Begin: proc "c" (mode: Enum)
impl_Bitmap: proc "c" (width: sizei, height: sizei, xorig: float, yorig: float, xmove: float, ymove: float, bitmap: cstring)
impl_Color3b: proc "c" (red: byte, green: byte, blue: byte)
impl_Color3bv: proc "c" (v: [^]byte)
impl_Color3d: proc "c" (red: double, green: double, blue: double)
impl_Color3dv: proc "c" (v: [^]double)
impl_Color3f: proc "c" (red: float, green: float, blue: float)
impl_Color3fv: proc "c" (v: [^]float)
impl_Color3i: proc "c" (red: int, green: int, blue: int)
impl_Color3iv: proc "c" (v: [^]int)
impl_Color3s: proc "c" (red: short, green: short, blue: short)
impl_Color3sv: proc "c" (v: [^]short)
impl_Color3ub: proc "c" (red: ubyte, green: ubyte, blue: ubyte)
impl_Color3ubv: proc "c" (v: cstring)
impl_Color3ui: proc "c" (red: uint, green: uint, blue: uint)
impl_Color3uiv: proc "c" (v: [^]uint)
impl_Color3us: proc "c" (red: ushort, green: ushort, blue: ushort)
impl_Color3usv: proc "c" (v: [^]ushort)
impl_Color4b: proc "c" (red: byte, green: byte, blue: byte, alpha: byte)
impl_Color4bv: proc "c" (v: [^]byte)
impl_Color4d: proc "c" (red: double, green: double, blue: double, alpha: double)
impl_Color4dv: proc "c" (v: [^]double)
impl_Color4f: proc "c" (red: float, green: float, blue: float, alpha: float)
impl_Color4fv: proc "c" (v: [^]float)
impl_Color4i: proc "c" (red: int, green: int, blue: int, alpha: int)
impl_Color4iv: proc "c" (v: [^]int)
impl_Color4s: proc "c" (red: short, green: short, blue: short, alpha: short)
impl_Color4sv: proc "c" (v: [^]short)
impl_Color4ub: proc "c" (red: ubyte, green: ubyte, blue: ubyte, alpha: ubyte)
impl_Color4ubv: proc "c" (v: cstring)
impl_Color4ui: proc "c" (red: uint, green: uint, blue: uint, alpha: uint)
impl_Color4uiv: proc "c" (v: [^]uint)
impl_Color4us: proc "c" (red: ushort, green: ushort, blue: ushort, alpha: ushort)
impl_Color4usv: proc "c" (v: [^]ushort)
impl_EdgeFlag: proc "c" (flag: boolean)
impl_EdgeFlagv: proc "c" (flag: [^]boolean)
impl_End: proc "c" ()
impl_Indexd: proc "c" (c: double)
impl_Indexdv: proc "c" (c: [^]double)
impl_Indexf: proc "c" (c: float)
impl_Indexfv: proc "c" (c: [^]float)
impl_Indexi: proc "c" (c: int)
impl_Indexiv: proc "c" (c: [^]int)
impl_Indexs: proc "c" (c: short)
impl_Indexsv: proc "c" (c: [^]short)
impl_Normal3b: proc "c" (nx: byte, ny: byte, nz: byte)
impl_Normal3bv: proc "c" (v: [^]byte)
impl_Normal3d: proc "c" (nx: double, ny: double, nz: double)
impl_Normal3dv: proc "c" (v: [^]double)
impl_Normal3f: proc "c" (nx: float, ny: float, nz: float)
impl_Normal3fv: proc "c" (v: [^]float)
impl_Normal3i: proc "c" (nx: int, ny: int, nz: int)
impl_Normal3iv: proc "c" (v: [^]int)
impl_Normal3s: proc "c" (nx: short, ny: short, nz: short)
impl_Normal3sv: proc "c" (v: [^]short)
impl_RasterPos2d: proc "c" (x: double, y: double)
impl_RasterPos2dv: proc "c" (v: [^]double)
impl_RasterPos2f: proc "c" (x: float, y: float)
impl_RasterPos2fv: proc "c" (v: [^]float)
impl_RasterPos2i: proc "c" (x: int, y: int)
impl_RasterPos2iv: proc "c" (v: [^]int)
impl_RasterPos2s: proc "c" (x: short, y: short)
impl_RasterPos2sv: proc "c" (v: [^]short)
impl_RasterPos3d: proc "c" (x: double, y: double, z: double)
impl_RasterPos3dv: proc "c" (v: [^]double)
impl_RasterPos3f: proc "c" (x: float, y: float, z: float)
impl_RasterPos3fv: proc "c" (v: [^]float)
impl_RasterPos3i: proc "c" (x: int, y: int, z: int)
impl_RasterPos3iv: proc "c" (v: [^]int)
impl_RasterPos3s: proc "c" (x: short, y: short, z: short)
impl_RasterPos3sv: proc "c" (v: [^]short)
impl_RasterPos4d: proc "c" (x: double, y: double, z: double, w: double)
impl_RasterPos4dv: proc "c" (v: [^]double)
impl_RasterPos4f: proc "c" (x: float, y: float, z: float, w: float)
impl_RasterPos4fv: proc "c" (v: [^]float)
impl_RasterPos4i: proc "c" (x: int, y: int, z: int, w: int)
impl_RasterPos4iv: proc "c" (v: [^]int)
impl_RasterPos4s: proc "c" (x: short, y: short, z: short, w: short)
impl_RasterPos4sv: proc "c" (v: [^]short)
impl_Rectd: proc "c" (x1: double, y1: double, x2: double, y2: double)
impl_Rectdv: proc "c" (v1: [^]double, v2: [^]double)
impl_Rectf: proc "c" (x1: float, y1: float, x2: float, y2: float)
impl_Rectfv: proc "c" (v1: [^]float, v2: [^]float)
impl_Recti: proc "c" (x1: int, y1: int, x2: int, y2: int)
impl_Rectiv: proc "c" (v1: [^]int, v2: [^]int)
impl_Rects: proc "c" (x1: short, y1: short, x2: short, y2: short)
impl_Rectsv: proc "c" (v1: [^]short, v2: [^]short)
impl_TexCoord1d: proc "c" (s: double)
impl_TexCoord1dv: proc "c" (v: [^]double)
impl_TexCoord1f: proc "c" (s: float)
impl_TexCoord1fv: proc "c" (v: [^]float)
impl_TexCoord1i: proc "c" (s: int)
impl_TexCoord1iv: proc "c" (v: [^]int)
impl_TexCoord1s: proc "c" (s: short)
impl_TexCoord1sv: proc "c" (v: [^]short)
impl_TexCoord2d: proc "c" (s: double, t: double)
impl_TexCoord2dv: proc "c" (v: [^]double)
impl_TexCoord2f: proc "c" (s: float, t: float)
impl_TexCoord2fv: proc "c" (v: [^]float)
impl_TexCoord2i: proc "c" (s: int, t: int)
impl_TexCoord2iv: proc "c" (v: [^]int)
impl_TexCoord2s: proc "c" (s: short, t: short)
impl_TexCoord2sv: proc "c" (v: [^]short)
impl_TexCoord3d: proc "c" (s: double, t: double, r: double)
impl_TexCoord3dv: proc "c" (v: [^]double)
impl_TexCoord3f: proc "c" (s: float, t: float, r: float)
impl_TexCoord3fv: proc "c" (v: [^]float)
impl_TexCoord3i: proc "c" (s: int, t: int, r: int)
impl_TexCoord3iv: proc "c" (v: [^]int)
impl_TexCoord3s: proc "c" (s: short, t: short, r: short)
impl_TexCoord3sv: proc "c" (v: [^]short)
impl_TexCoord4d: proc "c" (s: double, t: double, r: double, q: double)
impl_TexCoord4dv: proc "c" (v: [^]double)
impl_TexCoord4f: proc "c" (s: float, t: float, r: float, q: float)
impl_TexCoord4fv: proc "c" (v: [^]float)
impl_TexCoord4i: proc "c" (s: int, t: int, r: int, q: int)
impl_TexCoord4iv: proc "c" (v: [^]int)
impl_TexCoord4s: proc "c" (s: short, t: short, r: short, q: short)
impl_TexCoord4sv: proc "c" (v: [^]short)
impl_Vertex2d: proc "c" (x: double, y: double)
impl_Vertex2dv: proc "c" (v: [^]double)
impl_Vertex2f: proc "c" (x: float, y: float)
impl_Vertex2fv: proc "c" (v: [^]float)
impl_Vertex2i: proc "c" (x: int, y: int)
impl_Vertex2iv: proc "c" (v: [^]int)
impl_Vertex2s: proc "c" (x: short, y: short)
impl_Vertex2sv: proc "c" (v: [^]short)
impl_Vertex3d: proc "c" (x: double, y: double, z: double)
impl_Vertex3dv: proc "c" (v: [^]double)
impl_Vertex3f: proc "c" (x: float, y: float, z: float)
impl_Vertex3fv: proc "c" (v: [^]float)
impl_Vertex3i: proc "c" (x: int, y: int, z: int)
impl_Vertex3iv: proc "c" (v: [^]int)
impl_Vertex3s: proc "c" (x: short, y: short, z: short)
impl_Vertex3sv: proc "c" (v: [^]short)
impl_Vertex4d: proc "c" (x: double, y: double, z: double, w: double)
impl_Vertex4dv: proc "c" (v: [^]double)
impl_Vertex4f: proc "c" (x: float, y: float, z: float, w: float)
impl_Vertex4fv: proc "c" (v: [^]float)
impl_Vertex4i: proc "c" (x: int, y: int, z: int, w: int)
impl_Vertex4iv: proc "c" (v: [^]int)
impl_Vertex4s: proc "c" (x: short, y: short, z: short, w: short)
impl_Vertex4sv: proc "c" (v: [^]short)
impl_ClipPlane: proc "c" (plane: Enum, equation: [^]double)
impl_ColorMaterial: proc "c" (face: Enum, mode: Enum)
impl_Fogf: proc "c" (pname: Enum, param: float)
impl_Fogfv: proc "c" (pname: Enum, params: [^]float)
impl_Fogi: proc "c" (pname: Enum, param: int)
impl_Fogiv: proc "c" (pname: Enum, params: [^]int)
impl_Lightf: proc "c" (light: Enum, pname: Enum, param: float)
impl_Lightfv: proc "c" (light: Enum, pname: Enum, params: [^]float)
impl_Lighti: proc "c" (light: Enum, pname: Enum, param: int)
impl_Lightiv: proc "c" (light: Enum, pname: Enum, params: [^]int)
impl_LightModelf: proc "c" (pname: Enum, param: float)
impl_LightModelfv: proc "c" (pname: Enum, params: [^]float)
impl_LightModeli: proc "c" (pname: Enum, param: int)
impl_LightModeliv: proc "c" (pname: Enum, params: [^]int)
impl_LineStipple: proc "c" (factor: int, pattern: ushort)
impl_Materialf: proc "c" (face: Enum, pname: Enum, param: float)
impl_Materialfv: proc "c" (face: Enum, pname: Enum, params: [^]float)
impl_Materiali: proc "c" (face: Enum, pname: Enum, param: int)
impl_Materialiv: proc "c" (face: Enum, pname: Enum, params: [^]int)
impl_PolygonStipple: proc "c" (mask: cstring)
impl_ShadeModel: proc "c" (mode: Enum)
impl_TexEnvf: proc "c" (target: Enum, pname: Enum, param: float)
impl_TexEnvfv: proc "c" (target: Enum, pname: Enum, params: [^]float)
impl_TexEnvi: proc "c" (target: Enum, pname: Enum, param: int)
impl_TexEnviv: proc "c" (target: Enum, pname: Enum, params: [^]int)
impl_TexGend: proc "c" (coord: Enum, pname: Enum, param: double)
impl_TexGendv: proc "c" (coord: Enum, pname: Enum, params: [^]double)
impl_TexGenf: proc "c" (coord: Enum, pname: Enum, param: float)
impl_TexGenfv: proc "c" (coord: Enum, pname: Enum, params: [^]float)
impl_TexGeni: proc "c" (coord: Enum, pname: Enum, param: int)
impl_TexGeniv: proc "c" (coord: Enum, pname: Enum, params: [^]int)
impl_FeedbackBuffer: proc "c" (size: sizei, type: Enum, buffer: [^]float)
impl_SelectBuffer: proc "c" (size: sizei, buffer: [^]uint)
impl_RenderMode: proc "c" (mode: Enum) -> int
impl_InitNames: proc "c" ()
impl_LoadName: proc "c" (name: uint)
impl_PassThrough: proc "c" (token: float)
impl_PopName: proc "c" ()
impl_PushName: proc "c" (name: uint)
impl_ClearAccum: proc "c" (red: float, green: float, blue: float, alpha: float)
impl_ClearIndex: proc "c" (c: float)
impl_IndexMask: proc "c" (mask: uint)
impl_Accum: proc "c" (op: Enum, value: float)
impl_PopAttrib: proc "c" ()
impl_PushAttrib: proc "c" (mask: bitfield)
impl_Map1d: proc "c" (target: Enum, u1: double, u2: double, stride: int, order: int, points: [^]double)
impl_Map1f: proc "c" (target: Enum, u1: float, u2: float, stride: int, order: int, points: [^]float)
impl_Map2d: proc "c" (target: Enum, u1: double, u2: double, ustride: int, uorder: int, v1: double, v2: double, vstride: int, vorder: int, points: [^]double)
impl_Map2f: proc "c" (target: Enum, u1: float, u2: float, ustride: int, uorder: int, v1: float, v2: float, vstride: int, vorder: int, points: [^]float)
impl_MapGrid1d: proc "c" (un: int, u1: double, u2: double)
impl_MapGrid1f: proc "c" (un: int, u1: float, u2: float)
impl_MapGrid2d: proc "c" (un: int, u1: double, u2: double, vn: int, v1: double, v2: double)
impl_MapGrid2f: proc "c" (un: int, u1: float, u2: float, vn: int, v1: float, v2: float)
impl_EvalCoord1d: proc "c" (u: double)
impl_EvalCoord1dv: proc "c" (u: [^]double)
impl_EvalCoord1f: proc "c" (u: float)
impl_EvalCoord1fv: proc "c" (u: [^]float)
impl_EvalCoord2d: proc "c" (u: double, v: double)
impl_EvalCoord2dv: proc "c" (u: [^]double)
impl_EvalCoord2f: proc "c" (u: float, v: float)
impl_EvalCoord2fv: proc "c" (u: [^]float)
impl_EvalMesh1: proc "c" (mode: Enum, i1: int, i2: int)
impl_EvalPoint1: proc "c" (i: int)
impl_EvalMesh2: proc "c" (mode: Enum, i1: int, i2: int, j1: int, j2: int)
impl_EvalPoint2: proc "c" (i: int, j: int)
impl_AlphaFunc: proc "c" (func: Enum, ref: float)
impl_PixelZoom: proc "c" (xfactor: float, yfactor: float)
impl_PixelTransferf: proc "c" (pname: Enum, param: float)
impl_PixelTransferi: proc "c" (pname: Enum, param: int)
impl_PixelMapfv: proc "c" (_map: Enum, mapsize: sizei, values: [^]float)
impl_PixelMapuiv: proc "c" (_map: Enum, mapsize: sizei, values: [^]uint)
impl_PixelMapusv: proc "c" (_map: Enum, mapsize: sizei, values: [^]ushort)
impl_CopyPixels: proc "c" (x: int, y: int, width: sizei, height: sizei, type: Enum)
impl_DrawPixels: proc "c" (width: sizei, height: sizei, format: Enum, type: Enum, pixels: rawptr)
impl_GetClipPlane: proc "c" (plane: Enum, equation: [^]double)
impl_GetLightfv: proc "c" (light: Enum, pname: Enum, params: [^]float)
impl_GetLightiv: proc "c" (light: Enum, pname: Enum, params: [^]int)
impl_GetMapdv: proc "c" (target: Enum, query: Enum, v: [^]double)
impl_GetMapfv: proc "c" (target: Enum, query: Enum, v: [^]float)
impl_GetMapiv: proc "c" (target: Enum, query: Enum, v: [^]int)
impl_GetMaterialfv: proc "c" (face: Enum, pname: Enum, params: [^]float)
impl_GetMaterialiv: proc "c" (face: Enum, pname: Enum, params: [^]int)
impl_GetPixelMapfv: proc "c" (_map: Enum, values: [^]float)
impl_GetPixelMapuiv: proc "c" (_map: Enum, values: [^]uint)
impl_GetPixelMapusv: proc "c" (_map: Enum, values: [^]ushort)
impl_GetPolygonStipple: proc "c" (mask: [^]ubyte)
impl_GetTexEnvfv: proc "c" (target: Enum, pname: Enum, params: [^]float)
impl_GetTexEnviv: proc "c" (target: Enum, pname: Enum, params: [^]int)
impl_GetTexGendv: proc "c" (coord: Enum, pname: Enum, params: [^]double)
impl_GetTexGenfv: proc "c" (coord: Enum, pname: Enum, params: [^]float)
impl_GetTexGeniv: proc "c" (coord: Enum, pname: Enum, params: [^]int)
impl_IsList: proc "c" (list: uint) -> boolean
impl_Frustum: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double)
impl_LoadIdentity: proc "c" ()
impl_LoadMatrixf: proc "c" (m: [^]float)
impl_LoadMatrixd: proc "c" (m: [^]double)
impl_MatrixMode: proc "c" (mode: Enum)
impl_MultMatrixf: proc "c" (m: [^]float)
impl_MultMatrixd: proc "c" (m: [^]double)
impl_Ortho: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double)
impl_PopMatrix: proc "c" ()
impl_PushMatrix: proc "c" ()
impl_Rotated: proc "c" (angle: double, x: double, y: double, z: double)
impl_Rotatef: proc "c" (angle: float, x: float, y: float, z: float)
impl_Scaled: proc "c" (x: double, y: double, z: double)
impl_Scalef: proc "c" (x: float, y: float, z: float)
impl_Translated: proc "c" (x: double, y: double, z: double)
impl_Translatef: proc "c" (x: float, y: float, z: float)
// GL_VERSION_1_1
...
impl_ArrayElement: proc "c" (i: int)
impl_ColorPointer: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr)
impl_DisableClientState: proc "c" (array: Enum)
impl_EdgeFlagPointer: proc "c" (stride: sizei, pointer: rawptr)
impl_EnableClientState: proc "c" (array: Enum)
impl_IndexPointer: proc "c" (type: Enum, stride: sizei, pointer: rawptr)
impl_InterleavedArrays: proc "c" (format: Enum, stride: sizei, pointer: rawptr)
impl_NormalPointer: proc "c" (type: Enum, stride: sizei, pointer: rawptr)
impl_TexCoordPointer: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr)
impl_VertexPointer: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr)
impl_AreTexturesResident: proc "c" (n: sizei, textures: [^]uint, residences: [^]boolean) -> boolean
impl_PrioritizeTextures: proc "c" (n: sizei, textures: [^]uint, priorities: [^]float)
impl_Indexub: proc "c" (c: ubyte)
impl_Indexubv: proc "c" (c: cstring)
impl_PopClientAttrib: proc "c" ()
impl_PushClientAttrib: proc "c" (mask: bitfield)
// GL_VERSION_1_2
...
impl_ClientActiveTexture: proc "c" (texture: Enum)
impl_MultiTexCoord1d: proc "c" (target: Enum, s: double)
impl_MultiTexCoord1dv: proc "c" (target: Enum, v: [^]double)
impl_MultiTexCoord1f: proc "c" (target: Enum, s: float)
impl_MultiTexCoord1fv: proc "c" (target: Enum, v: [^]float)
impl_MultiTexCoord1i: proc "c" (target: Enum, s: int)
impl_MultiTexCoord1iv: proc "c" (target: Enum, v: [^]int)
impl_MultiTexCoord1s: proc "c" (target: Enum, s: short)
impl_MultiTexCoord1sv: proc "c" (target: Enum, v: [^]short)
impl_MultiTexCoord2d: proc "c" (target: Enum, s: double, t: double)
impl_MultiTexCoord2dv: proc "c" (target: Enum, v: [^]double)
impl_MultiTexCoord2f: proc "c" (target: Enum, s: float, t: float)
impl_MultiTexCoord2fv: proc "c" (target: Enum, v: [^]float)
impl_MultiTexCoord2i: proc "c" (target: Enum, s: int, t: int)
impl_MultiTexCoord2iv: proc "c" (target: Enum, v: [^]int)
impl_MultiTexCoord2s: proc "c" (target: Enum, s: short, t: short)
impl_MultiTexCoord2sv: proc "c" (target: Enum, v: [^]short)
impl_MultiTexCoord3d: proc "c" (target: Enum, s: double, t: double, r: double)
impl_MultiTexCoord3dv: proc "c" (target: Enum, v: [^]double)
impl_MultiTexCoord3f: proc "c" (target: Enum, s: float, t: float, r: float)
impl_MultiTexCoord3fv: proc "c" (target: Enum, v: [^]float)
impl_MultiTexCoord3i: proc "c" (target: Enum, s: int, t: int, r: int)
impl_MultiTexCoord3iv: proc "c" (target: Enum, v: [^]int)
impl_MultiTexCoord3s: proc "c" (target: Enum, s: short, t: short, r: short)
impl_MultiTexCoord3sv: proc "c" (target: Enum, v: [^]short)
impl_MultiTexCoord4d: proc "c" (target: Enum, s: double, t: double, r: double, q: double)
impl_MultiTexCoord4dv: proc "c" (target: Enum, v: [^]double)
impl_MultiTexCoord4f: proc "c" (target: Enum, s: float, t: float, r: float, q: float)
impl_MultiTexCoord4fv: proc "c" (target: Enum, v: [^]float)
impl_MultiTexCoord4i: proc "c" (target: Enum, s: int, t: int, r: int, q: int)
impl_MultiTexCoord4iv: proc "c" (target: Enum, v: [^]int)
impl_MultiTexCoord4s: proc "c" (target: Enum, s: short, t: short, r: short, q: short)
impl_MultiTexCoord4sv: proc "c" (target: Enum, v: [^]short)
impl_LoadTransposeMatrixf: proc "c" (m: [^]float)
impl_LoadTransposeMatrixd: proc "c" (m: [^]double)
impl_MultTransposeMatrixf: proc "c" (m: [^]float)
impl_MultTransposeMatrixd: proc "c" (m: [^]double)
// GL_VERSION_1_4
...
impl_FogCoordf: proc "c" (coord: float)
impl_FogCoordfv: proc "c" (coord: [^]float)
impl_FogCoordd: proc "c" (coord: double)
impl_FogCoorddv: proc "c" (coord: [^]double)
impl_FogCoordPointer: proc "c" (type: Enum, stride: sizei, pointer: rawptr)
impl_SecondaryColor3b: proc "c" (red: byte, green: byte, blue: byte)
impl_SecondaryColor3bv: proc "c" (v: [^]byte)
impl_SecondaryColor3d: proc "c" (red: double, green: double, blue: double)
impl_SecondaryColor3dv: proc "c" (v: [^]double)
impl_SecondaryColor3f: proc "c" (red: float, green: float, blue: float)
impl_SecondaryColor3fv: proc "c" (v: [^]float)
impl_SecondaryColor3i: proc "c" (red: int, green: int, blue: int)
impl_SecondaryColor3iv: proc "c" (v: [^]int)
impl_SecondaryColor3s: proc "c" (red: short, green: short, blue: short)
impl_SecondaryColor3sv: proc "c" (v: [^]short)
impl_SecondaryColor3ub: proc "c" (red: ubyte, green: ubyte, blue: ubyte)
impl_SecondaryColor3ubv: proc "c" (v: cstring)
impl_SecondaryColor3ui: proc "c" (red: uint, green: uint, blue: uint)
impl_SecondaryColor3uiv: proc "c" (v: [^]uint)
impl_SecondaryColor3us: proc "c" (red: ushort, green: ushort, blue: ushort)
impl_SecondaryColor3usv: proc "c" (v: [^]ushort)
impl_SecondaryColorPointer: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr)
impl_WindowPos2d: proc "c" (x: double, y: double)
impl_WindowPos2dv: proc "c" (v: [^]double)
impl_WindowPos2f: proc "c" (x: float, y: float)
impl_WindowPos2fv: proc "c" (v: [^]float)
impl_WindowPos2i: proc "c" (x: int, y: int)
impl_WindowPos2iv: proc "c" (v: [^]int)
impl_WindowPos2s: proc "c" (x: short, y: short)
impl_WindowPos2sv: proc "c" (v: [^]short)
impl_WindowPos3d: proc "c" (x: double, y: double, z: double)
impl_WindowPos3dv: proc "c" (v: [^]double)
impl_WindowPos3f: proc "c" (x: float, y: float, z: float)
impl_WindowPos3fv: proc "c" (v: [^]float)
impl_WindowPos3i: proc "c" (x: int, y: int, z: int)
impl_WindowPos3iv: proc "c" (v: [^]int)
impl_WindowPos3s: proc "c" (x: short, y: short, z: short)
impl_WindowPos3sv: proc "c" (v: [^]short)
...
impl_VertexAttribPointer: proc "c" (index: uint, size: int, type: Enum, normalized: boolean, stride: sizei, pointer: rawptr)
// GL_VERSION_2_1
...
impl_VertexP2ui: proc "c" (type: Enum, value: uint)
impl_VertexP2uiv: proc "c" (type: Enum, value: [^]uint)
impl_VertexP3ui: proc "c" (type: Enum, value: uint)
impl_VertexP3uiv: proc "c" (type: Enum, value: [^]uint)
impl_VertexP4ui: proc "c" (type: Enum, value: uint)
impl_VertexP4uiv: proc "c" (type: Enum, value: [^]uint)
impl_TexCoordP1ui: proc "c" (type: Enum, coords: uint)
impl_TexCoordP1uiv: proc "c" (type: Enum, coords: [^]uint)
impl_TexCoordP2ui: proc "c" (type: Enum, coords: uint)
impl_TexCoordP2uiv: proc "c" (type: Enum, coords: [^]uint)
impl_TexCoordP3ui: proc "c" (type: Enum, coords: uint)
impl_TexCoordP3uiv: proc "c" (type: Enum, coords: [^]uint)
impl_TexCoordP4ui: proc "c" (type: Enum, coords: uint)
impl_TexCoordP4uiv: proc "c" (type: Enum, coords: [^]uint)
impl_MultiTexCoordP1ui: proc "c" (texture: Enum, type: Enum, coords: uint)
impl_MultiTexCoordP1uiv: proc "c" (texture: Enum, type: Enum, coords: [^]uint)
impl_MultiTexCoordP2ui: proc "c" (texture: Enum, type: Enum, coords: uint)
impl_MultiTexCoordP2uiv: proc "c" (texture: Enum, type: Enum, coords: [^]uint)
impl_MultiTexCoordP3ui: proc "c" (texture: Enum, type: Enum, coords: uint)
impl_MultiTexCoordP3uiv: proc "c" (texture: Enum, type: Enum, coords: [^]uint)
impl_MultiTexCoordP4ui: proc "c" (texture: Enum, type: Enum, coords: uint)
impl_MultiTexCoordP4uiv: proc "c" (texture: Enum, type: Enum, coords: [^]uint)
impl_NormalP3ui: proc "c" (type: Enum, coords: uint)
impl_NormalP3uiv: proc "c" (type: Enum, coords: [^]uint)
impl_ColorP3ui: proc "c" (type: Enum, color: uint)
impl_ColorP3uiv: proc "c" (type: Enum, color: [^]uint)
impl_ColorP4ui: proc "c" (type: Enum, color: uint)
impl_ColorP4uiv: proc "c" (type: Enum, color: [^]uint)
impl_SecondaryColorP3ui: proc "c" (type: Enum, color: uint)
impl_SecondaryColorP3uiv: proc "c" (type: Enum, color: [^]uint)
// GL_VERSION_4_0
...
impl_GetnMapdv: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]double)
impl_GetnMapfv: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]float)
impl_GetnMapiv: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]int)
impl_GetnPixelMapfv: proc "c" (_map: Enum, bufSize: sizei, values: [^]float)
impl_GetnPixelMapuiv: proc "c" (_map: Enum, bufSize: sizei, values: [^]uint)
impl_GetnPixelMapusv: proc "c" (_map: Enum, bufSize: sizei, values: [^]ushort)
impl_GetnPolygonStipple: proc "c" (bufSize: sizei, pattern: [^]ubyte)
impl_GetnColorTable: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, table: rawptr)
impl_GetnConvolutionFilter: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, image: rawptr)
impl_GetnSeparableFilter: proc "c" (target: Enum, format: Enum, type: Enum, rowBufSize: sizei, row: rawptr, columnBufSize: sizei, column: rawptr, span: rawptr)
impl_GetnHistogram: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr)
impl_GetnMinmax: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr)
...
when GL_DEBUG {
    ...
    NewList :: proc "c" (list: uint, mode: Enum, loc := #caller_location) { impl_NewList(list, mode); debug_helper(loc, 0, list, mode);  }
    EndList :: proc "c" (loc := #caller_location) { impl_EndList(); debug_helper(loc, 0);  }
    CallList :: proc "c" (list: uint, loc := #caller_location) { impl_CallList(list); debug_helper(loc, 0, list);  }
    CallLists :: proc "c" (n: sizei, type: Enum, lists: rawptr, loc := #caller_location) { impl_CallLists(n, type, lists); debug_helper(loc, 0, n, type, lists);  }
    DeleteLists :: proc "c" (list: uint, range: sizei, loc := #caller_location) { impl_DeleteLists(list, range); debug_helper(loc, 0, list, range);  }
    GenLists :: proc "c" (range: sizei, loc := #caller_location) -> uint { ret := impl_GenLists(range); debug_helper(loc, 1, ret, range); return ret }
    ListBase :: proc "c" (base: uint, loc := #caller_location) { impl_ListBase(base); debug_helper(loc, 0, base);  }
    Begin :: proc "c" (mode: Enum, loc := #caller_location) { impl_Begin(mode); debug_helper(loc, 0, mode);  }
    Bitmap :: proc "c" (width: sizei, height: sizei, xorig: float, yorig: float, xmove: float, ymove: float, bitmap: cstring, loc := #caller_location) { impl_Bitmap(width, height, xorig, yorig, xmove, ymove, bitmap); debug_helper(loc, 0, width, height, xorig, yorig, xmove, ymove, bitmap);  }
    Color3b :: proc "c" (red: byte, green: byte, blue: byte, loc := #caller_location) { impl_Color3b(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3bv :: proc "c" (v: [^]byte, loc := #caller_location) { impl_Color3bv(v); debug_helper(loc, 0, v);  }
    Color3d :: proc "c" (red: double, green: double, blue: double, loc := #caller_location) { impl_Color3d(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Color3dv(v); debug_helper(loc, 0, v);  }
    Color3f :: proc "c" (red: float, green: float, blue: float, loc := #caller_location) { impl_Color3f(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Color3fv(v); debug_helper(loc, 0, v);  }
    Color3i :: proc "c" (red: int, green: int, blue: int, loc := #caller_location) { impl_Color3i(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Color3iv(v); debug_helper(loc, 0, v);  }
    Color3s :: proc "c" (red: short, green: short, blue: short, loc := #caller_location) { impl_Color3s(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Color3sv(v); debug_helper(loc, 0, v);  }
    Color3ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte, loc := #caller_location) { impl_Color3ub(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3ubv :: proc "c" (v: cstring, loc := #caller_location) { impl_Color3ubv(v); debug_helper(loc, 0, v);  }
    Color3ui :: proc "c" (red: uint, green: uint, blue: uint, loc := #caller_location) { impl_Color3ui(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3uiv :: proc "c" (v: [^]uint, loc := #caller_location) { impl_Color3uiv(v); debug_helper(loc, 0, v);  }
    Color3us :: proc "c" (red: ushort, green: ushort, blue: ushort, loc := #caller_location) { impl_Color3us(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    Color3usv :: proc "c" (v: [^]ushort, loc := #caller_location) { impl_Color3usv(v); debug_helper(loc, 0, v);  }
    Color4b :: proc "c" (red: byte, green: byte, blue: byte, alpha: byte, loc := #caller_location) { impl_Color4b(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4bv :: proc "c" (v: [^]byte, loc := #caller_location) { impl_Color4bv(v); debug_helper(loc, 0, v);  }
    Color4d :: proc "c" (red: double, green: double, blue: double, alpha: double, loc := #caller_location) { impl_Color4d(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Color4dv(v); debug_helper(loc, 0, v);  }
    Color4f :: proc "c" (red: float, green: float, blue: float, alpha: float, loc := #caller_location) { impl_Color4f(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Color4fv(v); debug_helper(loc, 0, v);  }
    Color4i :: proc "c" (red: int, green: int, blue: int, alpha: int, loc := #caller_location) { impl_Color4i(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Color4iv(v); debug_helper(loc, 0, v);  }
    Color4s :: proc "c" (red: short, green: short, blue: short, alpha: short, loc := #caller_location) { impl_Color4s(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Color4sv(v); debug_helper(loc, 0, v);  }
    Color4ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte, alpha: ubyte, loc := #caller_location) { impl_Color4ub(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4ubv :: proc "c" (v: cstring, loc := #caller_location) { impl_Color4ubv(v); debug_helper(loc, 0, v);  }
    Color4ui :: proc "c" (red: uint, green: uint, blue: uint, alpha: uint, loc := #caller_location) { impl_Color4ui(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4uiv :: proc "c" (v: [^]uint, loc := #caller_location) { impl_Color4uiv(v); debug_helper(loc, 0, v);  }
    Color4us :: proc "c" (red: ushort, green: ushort, blue: ushort, alpha: ushort, loc := #caller_location) { impl_Color4us(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    Color4usv :: proc "c" (v: [^]ushort, loc := #caller_location) { impl_Color4usv(v); debug_helper(loc, 0, v);  }
    EdgeFlag :: proc "c" (flag: boolean, loc := #caller_location) { impl_EdgeFlag(flag); debug_helper(loc, 0, flag);  }
    EdgeFlagv :: proc "c" (flag: [^]boolean, loc := #caller_location) { impl_EdgeFlagv(flag); debug_helper(loc, 0, flag);  }
    End :: proc "c" (loc := #caller_location) { impl_End(); debug_helper(loc, 0);  }
    Indexd :: proc "c" (c: double, loc := #caller_location) { impl_Indexd(c); debug_helper(loc, 0, c);  }
    Indexdv :: proc "c" (c: [^]double, loc := #caller_location) { impl_Indexdv(c); debug_helper(loc, 0, c);  }
    Indexf :: proc "c" (c: float, loc := #caller_location) { impl_Indexf(c); debug_helper(loc, 0, c);  }
    Indexfv :: proc "c" (c: [^]float, loc := #caller_location) { impl_Indexfv(c); debug_helper(loc, 0, c);  }
    Indexi :: proc "c" (c: int, loc := #caller_location) { impl_Indexi(c); debug_helper(loc, 0, c);  }
    Indexiv :: proc "c" (c: [^]int, loc := #caller_location) { impl_Indexiv(c); debug_helper(loc, 0, c);  }
    Indexs :: proc "c" (c: short, loc := #caller_location) { impl_Indexs(c); debug_helper(loc, 0, c);  }
    Indexsv :: proc "c" (c: [^]short, loc := #caller_location) { impl_Indexsv(c); debug_helper(loc, 0, c);  }
    Normal3b :: proc "c" (nx: byte, ny: byte, nz: byte, loc := #caller_location) { impl_Normal3b(nx, ny, nz); debug_helper(loc, 0, nx, ny, nz);  }
    Normal3bv :: proc "c" (v: [^]byte, loc := #caller_location) { impl_Normal3bv(v); debug_helper(loc, 0, v);  }
    Normal3d :: proc "c" (nx: double, ny: double, nz: double, loc := #caller_location) { impl_Normal3d(nx, ny, nz); debug_helper(loc, 0, nx, ny, nz);  }
    Normal3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Normal3dv(v); debug_helper(loc, 0, v);  }
    Normal3f :: proc "c" (nx: float, ny: float, nz: float, loc := #caller_location) { impl_Normal3f(nx, ny, nz); debug_helper(loc, 0, nx, ny, nz);  }
    Normal3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Normal3fv(v); debug_helper(loc, 0, v);  }
    Normal3i :: proc "c" (nx: int, ny: int, nz: int, loc := #caller_location) { impl_Normal3i(nx, ny, nz); debug_helper(loc, 0, nx, ny, nz);  }
    Normal3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Normal3iv(v); debug_helper(loc, 0, v);  }
    Normal3s :: proc "c" (nx: short, ny: short, nz: short, loc := #caller_location) { impl_Normal3s(nx, ny, nz); debug_helper(loc, 0, nx, ny, nz);  }
    Normal3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Normal3sv(v); debug_helper(loc, 0, v);  }
    RasterPos2d :: proc "c" (x: double, y: double, loc := #caller_location) { impl_RasterPos2d(x, y); debug_helper(loc, 0, x, y);  }
    RasterPos2dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_RasterPos2dv(v); debug_helper(loc, 0, v);  }
    RasterPos2f :: proc "c" (x: float, y: float, loc := #caller_location) { impl_RasterPos2f(x, y); debug_helper(loc, 0, x, y);  }
    RasterPos2fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_RasterPos2fv(v); debug_helper(loc, 0, v);  }
    RasterPos2i :: proc "c" (x: int, y: int, loc := #caller_location) { impl_RasterPos2i(x, y); debug_helper(loc, 0, x, y);  }
    RasterPos2iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_RasterPos2iv(v); debug_helper(loc, 0, v);  }
    RasterPos2s :: proc "c" (x: short, y: short, loc := #caller_location) { impl_RasterPos2s(x, y); debug_helper(loc, 0, x, y);  }
    RasterPos2sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_RasterPos2sv(v); debug_helper(loc, 0, v);  }
    RasterPos3d :: proc "c" (x: double, y: double, z: double, loc := #caller_location) { impl_RasterPos3d(x, y, z); debug_helper(loc, 0, x, y, z);  }
    RasterPos3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_RasterPos3dv(v); debug_helper(loc, 0, v);  }
    RasterPos3f :: proc "c" (x: float, y: float, z: float, loc := #caller_location) { impl_RasterPos3f(x, y, z); debug_helper(loc, 0, x, y, z);  }
    RasterPos3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_RasterPos3fv(v); debug_helper(loc, 0, v);  }
    RasterPos3i :: proc "c" (x: int, y: int, z: int, loc := #caller_location) { impl_RasterPos3i(x, y, z); debug_helper(loc, 0, x, y, z);  }
    RasterPos3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_RasterPos3iv(v); debug_helper(loc, 0, v);  }
    RasterPos3s :: proc "c" (x: short, y: short, z: short, loc := #caller_location) { impl_RasterPos3s(x, y, z); debug_helper(loc, 0, x, y, z);  }
    RasterPos3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_RasterPos3sv(v); debug_helper(loc, 0, v);  }
    RasterPos4d :: proc "c" (x: double, y: double, z: double, w: double, loc := #caller_location) { impl_RasterPos4d(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    RasterPos4dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_RasterPos4dv(v); debug_helper(loc, 0, v);  }
    RasterPos4f :: proc "c" (x: float, y: float, z: float, w: float, loc := #caller_location) { impl_RasterPos4f(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    RasterPos4fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_RasterPos4fv(v); debug_helper(loc, 0, v);  }
    RasterPos4i :: proc "c" (x: int, y: int, z: int, w: int, loc := #caller_location) { impl_RasterPos4i(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    RasterPos4iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_RasterPos4iv(v); debug_helper(loc, 0, v);  }
    RasterPos4s :: proc "c" (x: short, y: short, z: short, w: short, loc := #caller_location) { impl_RasterPos4s(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    RasterPos4sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_RasterPos4sv(v); debug_helper(loc, 0, v);  }
    Rectd :: proc "c" (x1: double, y1: double, x2: double, y2: double, loc := #caller_location) { impl_Rectd(x1, y1, x2, y2); debug_helper(loc, 0, x1, y1, x2, y2);  }
    Rectdv :: proc "c" (v1: [^]double, v2: [^]double, loc := #caller_location) { impl_Rectdv(v1, v2); debug_helper(loc, 0, v1, v2);  }
    Rectf :: proc "c" (x1: float, y1: float, x2: float, y2: float, loc := #caller_location) { impl_Rectf(x1, y1, x2, y2); debug_helper(loc, 0, x1, y1, x2, y2);  }
    Rectfv :: proc "c" (v1: [^]float, v2: [^]float, loc := #caller_location) { impl_Rectfv(v1, v2); debug_helper(loc, 0, v1, v2);  }
    Recti :: proc "c" (x1: int, y1: int, x2: int, y2: int, loc := #caller_location) { impl_Recti(x1, y1, x2, y2); debug_helper(loc, 0, x1, y1, x2, y2);  }
    Rectiv :: proc "c" (v1: [^]int, v2: [^]int, loc := #caller_location) { impl_Rectiv(v1, v2); debug_helper(loc, 0, v1, v2);  }
    Rects :: proc "c" (x1: short, y1: short, x2: short, y2: short, loc := #caller_location) { impl_Rects(x1, y1, x2, y2); debug_helper(loc, 0, x1, y1, x2, y2);  }
    Rectsv :: proc "c" (v1: [^]short, v2: [^]short, loc := #caller_location) { impl_Rectsv(v1, v2); debug_helper(loc, 0, v1, v2);  }
    TexCoord1d :: proc "c" (s: double, loc := #caller_location) { impl_TexCoord1d(s); debug_helper(loc, 0, s);  }
    TexCoord1dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_TexCoord1dv(v); debug_helper(loc, 0, v);  }
    TexCoord1f :: proc "c" (s: float, loc := #caller_location) { impl_TexCoord1f(s); debug_helper(loc, 0, s);  }
    TexCoord1fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_TexCoord1fv(v); debug_helper(loc, 0, v);  }
    TexCoord1i :: proc "c" (s: int, loc := #caller_location) { impl_TexCoord1i(s); debug_helper(loc, 0, s);  }
    TexCoord1iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_TexCoord1iv(v); debug_helper(loc, 0, v);  }
    TexCoord1s :: proc "c" (s: short, loc := #caller_location) { impl_TexCoord1s(s); debug_helper(loc, 0, s);  }
    TexCoord1sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_TexCoord1sv(v); debug_helper(loc, 0, v);  }
    TexCoord2d :: proc "c" (s: double, t: double, loc := #caller_location) { impl_TexCoord2d(s, t); debug_helper(loc, 0, s, t);  }
    TexCoord2dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_TexCoord2dv(v); debug_helper(loc, 0, v);  }
    TexCoord2f :: proc "c" (s: float, t: float, loc := #caller_location) { impl_TexCoord2f(s, t); debug_helper(loc, 0, s, t);  }
    TexCoord2fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_TexCoord2fv(v); debug_helper(loc, 0, v);  }
    TexCoord2i :: proc "c" (s: int, t: int, loc := #caller_location) { impl_TexCoord2i(s, t); debug_helper(loc, 0, s, t);  }
    TexCoord2iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_TexCoord2iv(v); debug_helper(loc, 0, v);  }
    TexCoord2s :: proc "c" (s: short, t: short, loc := #caller_location) { impl_TexCoord2s(s, t); debug_helper(loc, 0, s, t);  }
    TexCoord2sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_TexCoord2sv(v); debug_helper(loc, 0, v);  }
    TexCoord3d :: proc "c" (s: double, t: double, r: double, loc := #caller_location) { impl_TexCoord3d(s, t, r); debug_helper(loc, 0, s, t, r);  }
    TexCoord3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_TexCoord3dv(v); debug_helper(loc, 0, v);  }
    TexCoord3f :: proc "c" (s: float, t: float, r: float, loc := #caller_location) { impl_TexCoord3f(s, t, r); debug_helper(loc, 0, s, t, r);  }
    TexCoord3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_TexCoord3fv(v); debug_helper(loc, 0, v);  }
    TexCoord3i :: proc "c" (s: int, t: int, r: int, loc := #caller_location) { impl_TexCoord3i(s, t, r); debug_helper(loc, 0, s, t, r);  }
    TexCoord3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_TexCoord3iv(v); debug_helper(loc, 0, v);  }
    TexCoord3s :: proc "c" (s: short, t: short, r: short, loc := #caller_location) { impl_TexCoord3s(s, t, r); debug_helper(loc, 0, s, t, r);  }
    TexCoord3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_TexCoord3sv(v); debug_helper(loc, 0, v);  }
    TexCoord4d :: proc "c" (s: double, t: double, r: double, q: double, loc := #caller_location) { impl_TexCoord4d(s, t, r, q); debug_helper(loc, 0, s, t, r, q);  }
    TexCoord4dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_TexCoord4dv(v); debug_helper(loc, 0, v);  }
    TexCoord4f :: proc "c" (s: float, t: float, r: float, q: float, loc := #caller_location) { impl_TexCoord4f(s, t, r, q); debug_helper(loc, 0, s, t, r, q);  }
    TexCoord4fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_TexCoord4fv(v); debug_helper(loc, 0, v);  }
    TexCoord4i :: proc "c" (s: int, t: int, r: int, q: int, loc := #caller_location) { impl_TexCoord4i(s, t, r, q); debug_helper(loc, 0, s, t, r, q);  }
    TexCoord4iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_TexCoord4iv(v); debug_helper(loc, 0, v);  }
    TexCoord4s :: proc "c" (s: short, t: short, r: short, q: short, loc := #caller_location) { impl_TexCoord4s(s, t, r, q); debug_helper(loc, 0, s, t, r, q);  }
    TexCoord4sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_TexCoord4sv(v); debug_helper(loc, 0, v);  }
    Vertex2d :: proc "c" (x: double, y: double, loc := #caller_location) { impl_Vertex2d(x, y); debug_helper(loc, 0, x, y);  }
    Vertex2dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Vertex2dv(v); debug_helper(loc, 0, v);  }
    Vertex2f :: proc "c" (x: float, y: float, loc := #caller_location) { impl_Vertex2f(x, y); debug_helper(loc, 0, x, y);  }
    Vertex2fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Vertex2fv(v); debug_helper(loc, 0, v);  }
    Vertex2i :: proc "c" (x: int, y: int, loc := #caller_location) { impl_Vertex2i(x, y); debug_helper(loc, 0, x, y);  }
    Vertex2iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Vertex2iv(v); debug_helper(loc, 0, v);  }
    Vertex2s :: proc "c" (x: short, y: short, loc := #caller_location) { impl_Vertex2s(x, y); debug_helper(loc, 0, x, y);  }
    Vertex2sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Vertex2sv(v); debug_helper(loc, 0, v);  }
    Vertex3d :: proc "c" (x: double, y: double, z: double, loc := #caller_location) { impl_Vertex3d(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Vertex3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Vertex3dv(v); debug_helper(loc, 0, v);  }
    Vertex3f :: proc "c" (x: float, y: float, z: float, loc := #caller_location) { impl_Vertex3f(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Vertex3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Vertex3fv(v); debug_helper(loc, 0, v);  }
    Vertex3i :: proc "c" (x: int, y: int, z: int, loc := #caller_location) { impl_Vertex3i(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Vertex3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Vertex3iv(v); debug_helper(loc, 0, v);  }
    Vertex3s :: proc "c" (x: short, y: short, z: short, loc := #caller_location) { impl_Vertex3s(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Vertex3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Vertex3sv(v); debug_helper(loc, 0, v);  }
    Vertex4d :: proc "c" (x: double, y: double, z: double, w: double, loc := #caller_location) { impl_Vertex4d(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    Vertex4dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_Vertex4dv(v); debug_helper(loc, 0, v);  }
    Vertex4f :: proc "c" (x: float, y: float, z: float, w: float, loc := #caller_location) { impl_Vertex4f(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    Vertex4fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_Vertex4fv(v); debug_helper(loc, 0, v);  }
    Vertex4i :: proc "c" (x: int, y: int, z: int, w: int, loc := #caller_location) { impl_Vertex4i(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    Vertex4iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_Vertex4iv(v); debug_helper(loc, 0, v);  }
    Vertex4s :: proc "c" (x: short, y: short, z: short, w: short, loc := #caller_location) { impl_Vertex4s(x, y, z, w); debug_helper(loc, 0, x, y, z, w);  }
    Vertex4sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_Vertex4sv(v); debug_helper(loc, 0, v);  }
    ClipPlane :: proc "c" (plane: Enum, equation: [^]double, loc := #caller_location) { impl_ClipPlane(plane, equation); debug_helper(loc, 0, plane, equation);  }
    ColorMaterial :: proc "c" (face: Enum, mode: Enum, loc := #caller_location) { impl_ColorMaterial(face, mode); debug_helper(loc, 0, face, mode);  }
    Fogf :: proc "c" (pname: Enum, param: float, loc := #caller_location) { impl_Fogf(pname, param); debug_helper(loc, 0, pname, param);  }
    Fogfv :: proc "c" (pname: Enum, params: [^]float, loc := #caller_location) { impl_Fogfv(pname, params); debug_helper(loc, 0, pname, params);  }
    Fogi :: proc "c" (pname: Enum, param: int, loc := #caller_location) { impl_Fogi(pname, param); debug_helper(loc, 0, pname, param);  }
    Fogiv :: proc "c" (pname: Enum, params: [^]int, loc := #caller_location) { impl_Fogiv(pname, params); debug_helper(loc, 0, pname, params);  }
    Lightf :: proc "c" (light: Enum, pname: Enum, param: float, loc := #caller_location) { impl_Lightf(light, pname, param); debug_helper(loc, 0, light, pname, param);  }
    Lightfv :: proc "c" (light: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_Lightfv(light, pname, params); debug_helper(loc, 0, light, pname, params);  }
    Lighti :: proc "c" (light: Enum, pname: Enum, param: int, loc := #caller_location) { impl_Lighti(light, pname, param); debug_helper(loc, 0, light, pname, param);  }
    Lightiv :: proc "c" (light: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_Lightiv(light, pname, params); debug_helper(loc, 0, light, pname, params);  }
    LightModelf :: proc "c" (pname: Enum, param: float, loc := #caller_location) { impl_LightModelf(pname, param); debug_helper(loc, 0, pname, param);  }
    LightModelfv :: proc "c" (pname: Enum, params: [^]float, loc := #caller_location) { impl_LightModelfv(pname, params); debug_helper(loc, 0, pname, params);  }
    LightModeli :: proc "c" (pname: Enum, param: int, loc := #caller_location) { impl_LightModeli(pname, param); debug_helper(loc, 0, pname, param);  }
    LightModeliv :: proc "c" (pname: Enum, params: [^]int, loc := #caller_location) { impl_LightModeliv(pname, params); debug_helper(loc, 0, pname, params);  }
    LineStipple :: proc "c" (factor: int, pattern: ushort, loc := #caller_location) { impl_LineStipple(factor, pattern); debug_helper(loc, 0, factor, pattern);  }
    Materialf :: proc "c" (face: Enum, pname: Enum, param: float, loc := #caller_location) { impl_Materialf(face, pname, param); debug_helper(loc, 0, face, pname, param);  }
    Materialfv :: proc "c" (face: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_Materialfv(face, pname, params); debug_helper(loc, 0, face, pname, params);  }
    Materiali :: proc "c" (face: Enum, pname: Enum, param: int, loc := #caller_location) { impl_Materiali(face, pname, param); debug_helper(loc, 0, face, pname, param);  }
    Materialiv :: proc "c" (face: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_Materialiv(face, pname, params); debug_helper(loc, 0, face, pname, params);  }
    PolygonStipple :: proc "c" (mask: cstring, loc := #caller_location) { impl_PolygonStipple(mask); debug_helper(loc, 0, mask);  }
    ShadeModel :: proc "c" (mode: Enum, loc := #caller_location) { impl_ShadeModel(mode); debug_helper(loc, 0, mode);  }
    TexEnvf :: proc "c" (target: Enum, pname: Enum, param: float, loc := #caller_location) { impl_TexEnvf(target, pname, param); debug_helper(loc, 0, target, pname, param);  }
    TexEnvfv :: proc "c" (target: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_TexEnvfv(target, pname, params); debug_helper(loc, 0, target, pname, params);  }
    TexEnvi :: proc "c" (target: Enum, pname: Enum, param: int, loc := #caller_location) { impl_TexEnvi(target, pname, param); debug_helper(loc, 0, target, pname, param);  }
    TexEnviv :: proc "c" (target: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_TexEnviv(target, pname, params); debug_helper(loc, 0, target, pname, params);  }
    TexGend :: proc "c" (coord: Enum, pname: Enum, param: double, loc := #caller_location) { impl_TexGend(coord, pname, param); debug_helper(loc, 0, coord, pname, param);  }
    TexGendv :: proc "c" (coord: Enum, pname: Enum, params: [^]double, loc := #caller_location) { impl_TexGendv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    TexGenf :: proc "c" (coord: Enum, pname: Enum, param: float, loc := #caller_location) { impl_TexGenf(coord, pname, param); debug_helper(loc, 0, coord, pname, param);  }
    TexGenfv :: proc "c" (coord: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_TexGenfv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    TexGeni :: proc "c" (coord: Enum, pname: Enum, param: int, loc := #caller_location) { impl_TexGeni(coord, pname, param); debug_helper(loc, 0, coord, pname, param);  }
    TexGeniv :: proc "c" (coord: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_TexGeniv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    FeedbackBuffer :: proc "c" (size: sizei, type: Enum, buffer: [^]float, loc := #caller_location) { impl_FeedbackBuffer(size, type, buffer); debug_helper(loc, 0, size, type, buffer);  }
    SelectBuffer :: proc "c" (size: sizei, buffer: [^]uint, loc := #caller_location) { impl_SelectBuffer(size, buffer); debug_helper(loc, 0, size, buffer);  }
    RenderMode :: proc "c" (mode: Enum, loc := #caller_location) -> int { ret := impl_RenderMode(mode); debug_helper(loc, 1, ret, mode); return ret }
    InitNames :: proc "c" (loc := #caller_location) { impl_InitNames(); debug_helper(loc, 0);  }
    LoadName :: proc "c" (name: uint, loc := #caller_location) { impl_LoadName(name); debug_helper(loc, 0, name);  }
    PassThrough :: proc "c" (token: float, loc := #caller_location) { impl_PassThrough(token); debug_helper(loc, 0, token);  }
    PopName :: proc "c" (loc := #caller_location) { impl_PopName(); debug_helper(loc, 0);  }
    PushName :: proc "c" (name: uint, loc := #caller_location) { impl_PushName(name); debug_helper(loc, 0, name);  }
    ClearAccum :: proc "c" (red: float, green: float, blue: float, alpha: float, loc := #caller_location) { impl_ClearAccum(red, green, blue, alpha); debug_helper(loc, 0, red, green, blue, alpha);  }
    ClearIndex :: proc "c" (c: float, loc := #caller_location) { impl_ClearIndex(c); debug_helper(loc, 0, c);  }
    IndexMask :: proc "c" (mask: uint, loc := #caller_location) { impl_IndexMask(mask); debug_helper(loc, 0, mask);  }
    Accum :: proc "c" (op: Enum, value: float, loc := #caller_location) { impl_Accum(op, value); debug_helper(loc, 0, op, value);  }
    PopAttrib :: proc "c" (loc := #caller_location) { impl_PopAttrib(); debug_helper(loc, 0);  }
    PushAttrib :: proc "c" (mask: bitfield, loc := #caller_location) { impl_PushAttrib(mask); debug_helper(loc, 0, mask);  }
    Map1d :: proc "c" (target: Enum, u1: double, u2: double, stride: int, order: int, points: [^]double, loc := #caller_location) { impl_Map1d(target, u1, u2, stride, order, points); debug_helper(loc, 0, target, u1, u2, stride, order, points);  }
    Map1f :: proc "c" (target: Enum, u1: float, u2: float, stride: int, order: int, points: [^]float, loc := #caller_location) { impl_Map1f(target, u1, u2, stride, order, points); debug_helper(loc, 0, target, u1, u2, stride, order, points);  }
    Map2d :: proc "c" (target: Enum, u1: double, u2: double, ustride: int, uorder: int, v1: double, v2: double, vstride: int, vorder: int, points: [^]double, loc := #caller_location) { impl_Map2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points); debug_helper(loc, 0, target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);  }
    Map2f :: proc "c" (target: Enum, u1: float, u2: float, ustride: int, uorder: int, v1: float, v2: float, vstride: int, vorder: int, points: [^]float, loc := #caller_location) { impl_Map2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points); debug_helper(loc, 0, target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);  }
    MapGrid1d :: proc "c" (un: int, u1: double, u2: double, loc := #caller_location) { impl_MapGrid1d(un, u1, u2); debug_helper(loc, 0, un, u1, u2);  }
    MapGrid1f :: proc "c" (un: int, u1: float, u2: float, loc := #caller_location) { impl_MapGrid1f(un, u1, u2); debug_helper(loc, 0, un, u1, u2);  }
    MapGrid2d :: proc "c" (un: int, u1: double, u2: double, vn: int, v1: double, v2: double, loc := #caller_location) { impl_MapGrid2d(un, u1, u2, vn, v1, v2); debug_helper(loc, 0, un, u1, u2, vn, v1, v2);  }
    MapGrid2f :: proc "c" (un: int, u1: float, u2: float, vn: int, v1: float, v2: float, loc := #caller_location) { impl_MapGrid2f(un, u1, u2, vn, v1, v2); debug_helper(loc, 0, un, u1, u2, vn, v1, v2);  }
    EvalCoord1d :: proc "c" (u: double, loc := #caller_location) { impl_EvalCoord1d(u); debug_helper(loc, 0, u);  }
    EvalCoord1dv :: proc "c" (u: [^]double, loc := #caller_location) { impl_EvalCoord1dv(u); debug_helper(loc, 0, u);  }
    EvalCoord1f :: proc "c" (u: float, loc := #caller_location) { impl_EvalCoord1f(u); debug_helper(loc, 0, u);  }
    EvalCoord1fv :: proc "c" (u: [^]float, loc := #caller_location) { impl_EvalCoord1fv(u); debug_helper(loc, 0, u);  }
    EvalCoord2d :: proc "c" (u: double, v: double, loc := #caller_location) { impl_EvalCoord2d(u, v); debug_helper(loc, 0, u, v);  }
    EvalCoord2dv :: proc "c" (u: [^]double, loc := #caller_location) { impl_EvalCoord2dv(u); debug_helper(loc, 0, u);  }
    EvalCoord2f :: proc "c" (u: float, v: float, loc := #caller_location) { impl_EvalCoord2f(u, v); debug_helper(loc, 0, u, v);  }
    EvalCoord2fv :: proc "c" (u: [^]float, loc := #caller_location) { impl_EvalCoord2fv(u); debug_helper(loc, 0, u);  }
    EvalMesh1 :: proc "c" (mode: Enum, i1: int, i2: int, loc := #caller_location) { impl_EvalMesh1(mode, i1, i2); debug_helper(loc, 0, mode, i1, i2);  }
    EvalPoint1 :: proc "c" (i: int, loc := #caller_location) { impl_EvalPoint1(i); debug_helper(loc, 0, i);  }
    EvalMesh2 :: proc "c" (mode: Enum, i1: int, i2: int, j1: int, j2: int, loc := #caller_location) { impl_EvalMesh2(mode, i1, i2, j1, j2); debug_helper(loc, 0, mode, i1, i2, j1, j2);  }
    EvalPoint2 :: proc "c" (i: int, j: int, loc := #caller_location) { impl_EvalPoint2(i, j); debug_helper(loc, 0, i, j);  }
    AlphaFunc :: proc "c" (func: Enum, ref: float, loc := #caller_location) { impl_AlphaFunc(func, ref); debug_helper(loc, 0, func, ref);  }
    PixelZoom :: proc "c" (xfactor: float, yfactor: float, loc := #caller_location) { impl_PixelZoom(xfactor, yfactor); debug_helper(loc, 0, xfactor, yfactor);  }
    PixelTransferf :: proc "c" (pname: Enum, param: float, loc := #caller_location) { impl_PixelTransferf(pname, param); debug_helper(loc, 0, pname, param);  }
    PixelTransferi :: proc "c" (pname: Enum, param: int, loc := #caller_location) { impl_PixelTransferi(pname, param); debug_helper(loc, 0, pname, param);  }
    PixelMapfv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]float, loc := #caller_location) { impl_PixelMapfv(_map, mapsize, values); debug_helper(loc, 0, _map, mapsize, values);  }
    PixelMapuiv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]uint, loc := #caller_location) { impl_PixelMapuiv(_map, mapsize, values); debug_helper(loc, 0, _map, mapsize, values);  }
    PixelMapusv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]ushort, loc := #caller_location) { impl_PixelMapusv(_map, mapsize, values); debug_helper(loc, 0, _map, mapsize, values);  }
    CopyPixels :: proc "c" (x: int, y: int, width: sizei, height: sizei, type: Enum, loc := #caller_location) { impl_CopyPixels(x, y, width, height, type); debug_helper(loc, 0, x, y, width, height, type);  }
    DrawPixels :: proc "c" (width: sizei, height: sizei, format: Enum, type: Enum, pixels: rawptr, loc := #caller_location) { impl_DrawPixels(width, height, format, type, pixels); debug_helper(loc, 0, width, height, format, type, pixels);  }
    GetClipPlane :: proc "c" (plane: Enum, equation: [^]double, loc := #caller_location) { impl_GetClipPlane(plane, equation); debug_helper(loc, 0, plane, equation);  }
    GetLightfv :: proc "c" (light: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_GetLightfv(light, pname, params); debug_helper(loc, 0, light, pname, params);  }
    GetLightiv :: proc "c" (light: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_GetLightiv(light, pname, params); debug_helper(loc, 0, light, pname, params);  }
    GetMapdv :: proc "c" (target: Enum, query: Enum, v: [^]double, loc := #caller_location) { impl_GetMapdv(target, query, v); debug_helper(loc, 0, target, query, v);  }
    GetMapfv :: proc "c" (target: Enum, query: Enum, v: [^]float, loc := #caller_location) { impl_GetMapfv(target, query, v); debug_helper(loc, 0, target, query, v);  }
    GetMapiv :: proc "c" (target: Enum, query: Enum, v: [^]int, loc := #caller_location) { impl_GetMapiv(target, query, v); debug_helper(loc, 0, target, query, v);  }
    GetMaterialfv :: proc "c" (face: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_GetMaterialfv(face, pname, params); debug_helper(loc, 0, face, pname, params);  }
    GetMaterialiv :: proc "c" (face: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_GetMaterialiv(face, pname, params); debug_helper(loc, 0, face, pname, params);  }
    GetPixelMapfv :: proc "c" (_map: Enum, values: [^]float, loc := #caller_location) { impl_GetPixelMapfv(_map, values); debug_helper(loc, 0, _map, values);  }
    GetPixelMapuiv :: proc "c" (_map: Enum, values: [^]uint, loc := #caller_location) { impl_GetPixelMapuiv(_map, values); debug_helper(loc, 0, _map, values);  }
    GetPixelMapusv :: proc "c" (_map: Enum, values: [^]ushort, loc := #caller_location) { impl_GetPixelMapusv(_map, values); debug_helper(loc, 0, _map, values);  }
    GetPolygonStipple :: proc "c" (mask: [^]ubyte, loc := #caller_location) { impl_GetPolygonStipple(mask); debug_helper(loc, 0, mask);  }
    GetTexEnvfv :: proc "c" (target: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_GetTexEnvfv(target, pname, params); debug_helper(loc, 0, target, pname, params);  }
    GetTexEnviv :: proc "c" (target: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_GetTexEnviv(target, pname, params); debug_helper(loc, 0, target, pname, params);  }
    GetTexGendv :: proc "c" (coord: Enum, pname: Enum, params: [^]double, loc := #caller_location) { impl_GetTexGendv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    GetTexGenfv :: proc "c" (coord: Enum, pname: Enum, params: [^]float, loc := #caller_location) { impl_GetTexGenfv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    GetTexGeniv :: proc "c" (coord: Enum, pname: Enum, params: [^]int, loc := #caller_location) { impl_GetTexGeniv(coord, pname, params); debug_helper(loc, 0, coord, pname, params);  }
    IsList :: proc "c" (list: uint, loc := #caller_location) -> boolean { ret := impl_IsList(list); debug_helper(loc, 1, ret, list); return ret }
    Frustum :: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double, loc := #caller_location) { impl_Frustum(left, right, bottom, top, zNear, zFar); debug_helper(loc, 0, left, right, bottom, top, zNear, zFar);  }
    LoadIdentity :: proc "c" (loc := #caller_location) { impl_LoadIdentity(); debug_helper(loc, 0);  }
    LoadMatrixf :: proc "c" (m: [^]float, loc := #caller_location) { impl_LoadMatrixf(m); debug_helper(loc, 0, m);  }
    LoadMatrixd :: proc "c" (m: [^]double, loc := #caller_location) { impl_LoadMatrixd(m); debug_helper(loc, 0, m);  }
    MatrixMode :: proc "c" (mode: Enum, loc := #caller_location) { impl_MatrixMode(mode); debug_helper(loc, 0, mode);  }
    MultMatrixf :: proc "c" (m: [^]float, loc := #caller_location) { impl_MultMatrixf(m); debug_helper(loc, 0, m);  }
    MultMatrixd :: proc "c" (m: [^]double, loc := #caller_location) { impl_MultMatrixd(m); debug_helper(loc, 0, m);  }
    Ortho :: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double, loc := #caller_location) { impl_Ortho(left, right, bottom, top, zNear, zFar); debug_helper(loc, 0, left, right, bottom, top, zNear, zFar);  }
    PopMatrix :: proc "c" (loc := #caller_location) { impl_PopMatrix(); debug_helper(loc, 0);  }
    PushMatrix :: proc "c" (loc := #caller_location) { impl_PushMatrix(); debug_helper(loc, 0);  }
    Rotated :: proc "c" (angle: double, x: double, y: double, z: double, loc := #caller_location) { impl_Rotated(angle, x, y, z); debug_helper(loc, 0, angle, x, y, z);  }
    Rotatef :: proc "c" (angle: float, x: float, y: float, z: float, loc := #caller_location) { impl_Rotatef(angle, x, y, z); debug_helper(loc, 0, angle, x, y, z);  }
    Scaled :: proc "c" (x: double, y: double, z: double, loc := #caller_location) { impl_Scaled(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Scalef :: proc "c" (x: float, y: float, z: float, loc := #caller_location) { impl_Scalef(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Translated :: proc "c" (x: double, y: double, z: double, loc := #caller_location) { impl_Translated(x, y, z); debug_helper(loc, 0, x, y, z);  }
    Translatef :: proc "c" (x: float, y: float, z: float, loc := #caller_location) { impl_Translatef(x, y, z); debug_helper(loc, 0, x, y, z);  }
    ...
    ArrayElement :: proc "c" (i: int, loc := #caller_location) { impl_ArrayElement(i); debug_helper(loc, 0, i);  }
    ColorPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_ColorPointer(size, type, stride, pointer); debug_helper(loc, 0, size, type, stride, pointer);  }
    DisableClientState :: proc "c" (array: Enum, loc := #caller_location) { impl_DisableClientState(array); debug_helper(loc, 0, array);  }
    EdgeFlagPointer :: proc "c" (stride: sizei, pointer: rawptr, loc := #caller_location) { impl_EdgeFlagPointer(stride, pointer); debug_helper(loc, 0, stride, pointer);  }
    EnableClientState :: proc "c" (array: Enum, loc := #caller_location) { impl_EnableClientState(array); debug_helper(loc, 0, array);  }
    IndexPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_IndexPointer(type, stride, pointer); debug_helper(loc, 0, type, stride, pointer);  }
    InterleavedArrays :: proc "c" (format: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_InterleavedArrays(format, stride, pointer); debug_helper(loc, 0, format, stride, pointer);  }
    NormalPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_NormalPointer(type, stride, pointer); debug_helper(loc, 0, type, stride, pointer);  }
    TexCoordPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_TexCoordPointer(size, type, stride, pointer); debug_helper(loc, 0, size, type, stride, pointer);  }
    VertexPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_VertexPointer(size, type, stride, pointer); debug_helper(loc, 0, size, type, stride, pointer);  }
    AreTexturesResident :: proc "c" (n: sizei, textures: [^]uint, residences: [^]boolean, loc := #caller_location) -> boolean { ret := impl_AreTexturesResident(n, textures, residences); debug_helper(loc, 1, ret, n, textures, residences); return ret }
    PrioritizeTextures :: proc "c" (n: sizei, textures: [^]uint, priorities: [^]float, loc := #caller_location) { impl_PrioritizeTextures(n, textures, priorities); debug_helper(loc, 0, n, textures, priorities);  }
    Indexub :: proc "c" (c: ubyte, loc := #caller_location) { impl_Indexub(c); debug_helper(loc, 0, c);  }
    Indexubv :: proc "c" (c: cstring, loc := #caller_location) { impl_Indexubv(c); debug_helper(loc, 0, c);  }
    PopClientAttrib :: proc "c" (loc := #caller_location) { impl_PopClientAttrib(); debug_helper(loc, 0);  }
    PushClientAttrib :: proc "c" (mask: bitfield, loc := #caller_location) { impl_PushClientAttrib(mask); debug_helper(loc, 0, mask);  }
    ...
    ClientActiveTexture :: proc "c" (texture: Enum, loc := #caller_location) { impl_ClientActiveTexture(texture); debug_helper(loc, 0, texture);  }
    MultiTexCoord1d :: proc "c" (target: Enum, s: double, loc := #caller_location) { impl_MultiTexCoord1d(target, s); debug_helper(loc, 0, target, s);  }
    MultiTexCoord1dv :: proc "c" (target: Enum, v: [^]double, loc := #caller_location) { impl_MultiTexCoord1dv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord1f :: proc "c" (target: Enum, s: float, loc := #caller_location) { impl_MultiTexCoord1f(target, s); debug_helper(loc, 0, target, s);  }
    MultiTexCoord1fv :: proc "c" (target: Enum, v: [^]float, loc := #caller_location) { impl_MultiTexCoord1fv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord1i :: proc "c" (target: Enum, s: int, loc := #caller_location) { impl_MultiTexCoord1i(target, s); debug_helper(loc, 0, target, s);  }
    MultiTexCoord1iv :: proc "c" (target: Enum, v: [^]int, loc := #caller_location) { impl_MultiTexCoord1iv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord1s :: proc "c" (target: Enum, s: short, loc := #caller_location) { impl_MultiTexCoord1s(target, s); debug_helper(loc, 0, target, s);  }
    MultiTexCoord1sv :: proc "c" (target: Enum, v: [^]short, loc := #caller_location) { impl_MultiTexCoord1sv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord2d :: proc "c" (target: Enum, s: double, t: double, loc := #caller_location) { impl_MultiTexCoord2d(target, s, t); debug_helper(loc, 0, target, s, t);  }
    MultiTexCoord2dv :: proc "c" (target: Enum, v: [^]double, loc := #caller_location) { impl_MultiTexCoord2dv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord2f :: proc "c" (target: Enum, s: float, t: float, loc := #caller_location) { impl_MultiTexCoord2f(target, s, t); debug_helper(loc, 0, target, s, t);  }
    MultiTexCoord2fv :: proc "c" (target: Enum, v: [^]float, loc := #caller_location) { impl_MultiTexCoord2fv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord2i :: proc "c" (target: Enum, s: int, t: int, loc := #caller_location) { impl_MultiTexCoord2i(target, s, t); debug_helper(loc, 0, target, s, t);  }
    MultiTexCoord2iv :: proc "c" (target: Enum, v: [^]int, loc := #caller_location) { impl_MultiTexCoord2iv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord2s :: proc "c" (target: Enum, s: short, t: short, loc := #caller_location) { impl_MultiTexCoord2s(target, s, t); debug_helper(loc, 0, target, s, t);  }
    MultiTexCoord2sv :: proc "c" (target: Enum, v: [^]short, loc := #caller_location) { impl_MultiTexCoord2sv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord3d :: proc "c" (target: Enum, s: double, t: double, r: double, loc := #caller_location) { impl_MultiTexCoord3d(target, s, t, r); debug_helper(loc, 0, target, s, t, r);  }
    MultiTexCoord3dv :: proc "c" (target: Enum, v: [^]double, loc := #caller_location) { impl_MultiTexCoord3dv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord3f :: proc "c" (target: Enum, s: float, t: float, r: float, loc := #caller_location) { impl_MultiTexCoord3f(target, s, t, r); debug_helper(loc, 0, target, s, t, r);  }
    MultiTexCoord3fv :: proc "c" (target: Enum, v: [^]float, loc := #caller_location) { impl_MultiTexCoord3fv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord3i :: proc "c" (target: Enum, s: int, t: int, r: int, loc := #caller_location) { impl_MultiTexCoord3i(target, s, t, r); debug_helper(loc, 0, target, s, t, r);  }
    MultiTexCoord3iv :: proc "c" (target: Enum, v: [^]int, loc := #caller_location) { impl_MultiTexCoord3iv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord3s :: proc "c" (target: Enum, s: short, t: short, r: short, loc := #caller_location) { impl_MultiTexCoord3s(target, s, t, r); debug_helper(loc, 0, target, s, t, r);  }
    MultiTexCoord3sv :: proc "c" (target: Enum, v: [^]short, loc := #caller_location) { impl_MultiTexCoord3sv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord4d :: proc "c" (target: Enum, s: double, t: double, r: double, q: double, loc := #caller_location) { impl_MultiTexCoord4d(target, s, t, r, q); debug_helper(loc, 0, target, s, t, r, q);  }
    MultiTexCoord4dv :: proc "c" (target: Enum, v: [^]double, loc := #caller_location) { impl_MultiTexCoord4dv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord4f :: proc "c" (target: Enum, s: float, t: float, r: float, q: float, loc := #caller_location) { impl_MultiTexCoord4f(target, s, t, r, q); debug_helper(loc, 0, target, s, t, r, q);  }
    MultiTexCoord4fv :: proc "c" (target: Enum, v: [^]float, loc := #caller_location) { impl_MultiTexCoord4fv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord4i :: proc "c" (target: Enum, s: int, t: int, r: int, q: int, loc := #caller_location) { impl_MultiTexCoord4i(target, s, t, r, q); debug_helper(loc, 0, target, s, t, r, q);  }
    MultiTexCoord4iv :: proc "c" (target: Enum, v: [^]int, loc := #caller_location) { impl_MultiTexCoord4iv(target, v); debug_helper(loc, 0, target, v);  }
    MultiTexCoord4s :: proc "c" (target: Enum, s: short, t: short, r: short, q: short, loc := #caller_location) { impl_MultiTexCoord4s(target, s, t, r, q); debug_helper(loc, 0, target, s, t, r, q);  }
    MultiTexCoord4sv :: proc "c" (target: Enum, v: [^]short, loc := #caller_location) { impl_MultiTexCoord4sv(target, v); debug_helper(loc, 0, target, v);  }
    LoadTransposeMatrixf :: proc "c" (m: [^]float, loc := #caller_location) { impl_LoadTransposeMatrixf(m); debug_helper(loc, 0, m);  }
    LoadTransposeMatrixd :: proc "c" (m: [^]double, loc := #caller_location) { impl_LoadTransposeMatrixd(m); debug_helper(loc, 0, m);  }
    MultTransposeMatrixf :: proc "c" (m: [^]float, loc := #caller_location) { impl_MultTransposeMatrixf(m); debug_helper(loc, 0, m);  }
    MultTransposeMatrixd :: proc "c" (m: [^]double, loc := #caller_location) { impl_MultTransposeMatrixd(m); debug_helper(loc, 0, m);  }
    ...
    FogCoordf :: proc "c" (coord: float, loc := #caller_location) { impl_FogCoordf(coord); debug_helper(loc, 0, coord);  }
    FogCoordfv :: proc "c" (coord: [^]float, loc := #caller_location) { impl_FogCoordfv(coord); debug_helper(loc, 0, coord);  }
    FogCoordd :: proc "c" (coord: double, loc := #caller_location) { impl_FogCoordd(coord); debug_helper(loc, 0, coord);  }
    FogCoorddv :: proc "c" (coord: [^]double, loc := #caller_location) { impl_FogCoorddv(coord); debug_helper(loc, 0, coord);  }
    FogCoordPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_FogCoordPointer(type, stride, pointer); debug_helper(loc, 0, type, stride, pointer);  }
    SecondaryColor3b :: proc "c" (red: byte, green: byte, blue: byte, loc := #caller_location) { impl_SecondaryColor3b(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3bv :: proc "c" (v: [^]byte, loc := #caller_location) { impl_SecondaryColor3bv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3d :: proc "c" (red: double, green: double, blue: double, loc := #caller_location) { impl_SecondaryColor3d(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_SecondaryColor3dv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3f :: proc "c" (red: float, green: float, blue: float, loc := #caller_location) { impl_SecondaryColor3f(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_SecondaryColor3fv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3i :: proc "c" (red: int, green: int, blue: int, loc := #caller_location) { impl_SecondaryColor3i(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_SecondaryColor3iv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3s :: proc "c" (red: short, green: short, blue: short, loc := #caller_location) { impl_SecondaryColor3s(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_SecondaryColor3sv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte, loc := #caller_location) { impl_SecondaryColor3ub(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3ubv :: proc "c" (v: cstring, loc := #caller_location) { impl_SecondaryColor3ubv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3ui :: proc "c" (red: uint, green: uint, blue: uint, loc := #caller_location) { impl_SecondaryColor3ui(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3uiv :: proc "c" (v: [^]uint, loc := #caller_location) { impl_SecondaryColor3uiv(v); debug_helper(loc, 0, v);  }
    SecondaryColor3us :: proc "c" (red: ushort, green: ushort, blue: ushort, loc := #caller_location) { impl_SecondaryColor3us(red, green, blue); debug_helper(loc, 0, red, green, blue);  }
    SecondaryColor3usv :: proc "c" (v: [^]ushort, loc := #caller_location) { impl_SecondaryColor3usv(v); debug_helper(loc, 0, v);  }
    SecondaryColorPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_SecondaryColorPointer(size, type, stride, pointer); debug_helper(loc, 0, size, type, stride, pointer);  }
    WindowPos2d :: proc "c" (x: double, y: double, loc := #caller_location) { impl_WindowPos2d(x, y); debug_helper(loc, 0, x, y);  }
    WindowPos2dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_WindowPos2dv(v); debug_helper(loc, 0, v);  }
    WindowPos2f :: proc "c" (x: float, y: float, loc := #caller_location) { impl_WindowPos2f(x, y); debug_helper(loc, 0, x, y);  }
    WindowPos2fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_WindowPos2fv(v); debug_helper(loc, 0, v);  }
    WindowPos2i :: proc "c" (x: int, y: int, loc := #caller_location) { impl_WindowPos2i(x, y); debug_helper(loc, 0, x, y);  }
    WindowPos2iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_WindowPos2iv(v); debug_helper(loc, 0, v);  }
    WindowPos2s :: proc "c" (x: short, y: short, loc := #caller_location) { impl_WindowPos2s(x, y); debug_helper(loc, 0, x, y);  }
    WindowPos2sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_WindowPos2sv(v); debug_helper(loc, 0, v);  }
    WindowPos3d :: proc "c" (x: double, y: double, z: double, loc := #caller_location) { impl_WindowPos3d(x, y, z); debug_helper(loc, 0, x, y, z);  }
    WindowPos3dv :: proc "c" (v: [^]double, loc := #caller_location) { impl_WindowPos3dv(v); debug_helper(loc, 0, v);  }
    WindowPos3f :: proc "c" (x: float, y: float, z: float, loc := #caller_location) { impl_WindowPos3f(x, y, z); debug_helper(loc, 0, x, y, z);  }
    WindowPos3fv :: proc "c" (v: [^]float, loc := #caller_location) { impl_WindowPos3fv(v); debug_helper(loc, 0, v);  }
    WindowPos3i :: proc "c" (x: int, y: int, z: int, loc := #caller_location) { impl_WindowPos3i(x, y, z); debug_helper(loc, 0, x, y, z);  }
    WindowPos3iv :: proc "c" (v: [^]int, loc := #caller_location) { impl_WindowPos3iv(v); debug_helper(loc, 0, v);  }
    WindowPos3s :: proc "c" (x: short, y: short, z: short, loc := #caller_location) { impl_WindowPos3s(x, y, z); debug_helper(loc, 0, x, y, z);  }
    WindowPos3sv :: proc "c" (v: [^]short, loc := #caller_location) { impl_WindowPos3sv(v); debug_helper(loc, 0, v);  }
    ...
    VertexAttribPointer :: proc "c" (index: uint, size: int, type: Enum, normalized: boolean, stride: sizei, pointer: rawptr, loc := #caller_location) { impl_VertexAttribPointer(index, size, type, normalized, stride, pointer); debug_helper(loc, 0, index, size, type, normalized, stride, pointer);  }
    ...
    VertexP2ui :: proc "c" (type: Enum, value: uint, loc := #caller_location) { impl_VertexP2ui(type, value); debug_helper(loc, 0, type, value);  }
    VertexP2uiv :: proc "c" (type: Enum, value: [^]uint, loc := #caller_location) { impl_VertexP2uiv(type, value); debug_helper(loc, 0, type, value);  }
    VertexP3ui :: proc "c" (type: Enum, value: uint, loc := #caller_location) { impl_VertexP3ui(type, value); debug_helper(loc, 0, type, value);  }
    VertexP3uiv :: proc "c" (type: Enum, value: [^]uint, loc := #caller_location) { impl_VertexP3uiv(type, value); debug_helper(loc, 0, type, value);  }
    VertexP4ui :: proc "c" (type: Enum, value: uint, loc := #caller_location) { impl_VertexP4ui(type, value); debug_helper(loc, 0, type, value);  }
    VertexP4uiv :: proc "c" (type: Enum, value: [^]uint, loc := #caller_location) { impl_VertexP4uiv(type, value); debug_helper(loc, 0, type, value);  }
    TexCoordP1ui :: proc "c" (type: Enum, coords: uint, loc := #caller_location) { impl_TexCoordP1ui(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP1uiv :: proc "c" (type: Enum, coords: [^]uint, loc := #caller_location) { impl_TexCoordP1uiv(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP2ui :: proc "c" (type: Enum, coords: uint, loc := #caller_location) { impl_TexCoordP2ui(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP2uiv :: proc "c" (type: Enum, coords: [^]uint, loc := #caller_location) { impl_TexCoordP2uiv(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP3ui :: proc "c" (type: Enum, coords: uint, loc := #caller_location) { impl_TexCoordP3ui(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP3uiv :: proc "c" (type: Enum, coords: [^]uint, loc := #caller_location) { impl_TexCoordP3uiv(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP4ui :: proc "c" (type: Enum, coords: uint, loc := #caller_location) { impl_TexCoordP4ui(type, coords); debug_helper(loc, 0, type, coords);  }
    TexCoordP4uiv :: proc "c" (type: Enum, coords: [^]uint, loc := #caller_location) { impl_TexCoordP4uiv(type, coords); debug_helper(loc, 0, type, coords);  }
    MultiTexCoordP1ui :: proc "c" (texture: Enum, type: Enum, coords: uint, loc := #caller_location) { impl_MultiTexCoordP1ui(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP1uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint, loc := #caller_location) { impl_MultiTexCoordP1uiv(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP2ui :: proc "c" (texture: Enum, type: Enum, coords: uint, loc := #caller_location) { impl_MultiTexCoordP2ui(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP2uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint, loc := #caller_location) { impl_MultiTexCoordP2uiv(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP3ui :: proc "c" (texture: Enum, type: Enum, coords: uint, loc := #caller_location) { impl_MultiTexCoordP3ui(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP3uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint, loc := #caller_location) { impl_MultiTexCoordP3uiv(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP4ui :: proc "c" (texture: Enum, type: Enum, coords: uint, loc := #caller_location) { impl_MultiTexCoordP4ui(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    MultiTexCoordP4uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint, loc := #caller_location) { impl_MultiTexCoordP4uiv(texture, type, coords); debug_helper(loc, 0, texture, type, coords);  }
    NormalP3ui :: proc "c" (type: Enum, coords: uint, loc := #caller_location) { impl_NormalP3ui(type, coords); debug_helper(loc, 0, type, coords);  }
    NormalP3uiv :: proc "c" (type: Enum, coords: [^]uint, loc := #caller_location) { impl_NormalP3uiv(type, coords); debug_helper(loc, 0, type, coords);  }
    ColorP3ui :: proc "c" (type: Enum, color: uint, loc := #caller_location) { impl_ColorP3ui(type, color); debug_helper(loc, 0, type, color);  }
    ColorP3uiv :: proc "c" (type: Enum, color: [^]uint, loc := #caller_location) { impl_ColorP3uiv(type, color); debug_helper(loc, 0, type, color);  }
    ColorP4ui :: proc "c" (type: Enum, color: uint, loc := #caller_location) { impl_ColorP4ui(type, color); debug_helper(loc, 0, type, color);  }
    ColorP4uiv :: proc "c" (type: Enum, color: [^]uint, loc := #caller_location) { impl_ColorP4uiv(type, color); debug_helper(loc, 0, type, color);  }
    SecondaryColorP3ui :: proc "c" (type: Enum, color: uint, loc := #caller_location) { impl_SecondaryColorP3ui(type, color); debug_helper(loc, 0, type, color);  }
    SecondaryColorP3uiv :: proc "c" (type: Enum, color: [^]uint, loc := #caller_location) { impl_SecondaryColorP3uiv(type, color); debug_helper(loc, 0, type, color);  }
    ...
    GetnMapdv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]double, loc := #caller_location) { impl_GetnMapdv(target, query, bufSize, v); debug_helper(loc, 0, target, query, bufSize, v);  }
    GetnMapfv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]float, loc := #caller_location) { impl_GetnMapfv(target, query, bufSize, v); debug_helper(loc, 0, target, query, bufSize, v);  }
    GetnMapiv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]int, loc := #caller_location) { impl_GetnMapiv(target, query, bufSize, v); debug_helper(loc, 0, target, query, bufSize, v);  }
    GetnPixelMapfv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]float, loc := #caller_location) { impl_GetnPixelMapfv(_map, bufSize, values); debug_helper(loc, 0, _map, bufSize, values);  }
    GetnPixelMapuiv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]uint, loc := #caller_location) { impl_GetnPixelMapuiv(_map, bufSize, values); debug_helper(loc, 0, _map, bufSize, values);  }
    GetnPixelMapusv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]ushort, loc := #caller_location) { impl_GetnPixelMapusv(_map, bufSize, values); debug_helper(loc, 0, _map, bufSize, values);  }
    GetnPolygonStipple :: proc "c" (bufSize: sizei, pattern: [^]ubyte, loc := #caller_location) { impl_GetnPolygonStipple(bufSize, pattern); debug_helper(loc, 0, bufSize, pattern);  }
    GetnColorTable :: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, table: rawptr, loc := #caller_location) { impl_GetnColorTable(target, format, type, bufSize, table); debug_helper(loc, 0, target, format, type, bufSize, table);  }
    GetnConvolutionFilter :: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, image: rawptr, loc := #caller_location) { impl_GetnConvolutionFilter(target, format, type, bufSize, image); debug_helper(loc, 0, target, format, type, bufSize, image);  }
    GetnSeparableFilter :: proc "c" (target: Enum, format: Enum, type: Enum, rowBufSize: sizei, row: rawptr, columnBufSize: sizei, column: rawptr, span: rawptr, loc := #caller_location) { impl_GetnSeparableFilter(target, format, type, rowBufSize, row, columnBufSize, column, span); debug_helper(loc, 0, target, format, type, rowBufSize, row, columnBufSize, column, span);  }
    GetnHistogram :: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr, loc := #caller_location) { impl_GetnHistogram(target, reset, format, type, bufSize, values); debug_helper(loc, 0, target, reset, format, type, bufSize, values);  }
    GetnMinmax :: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr, loc := #caller_location) { impl_GetnMinmax(target, reset, format, type, bufSize, values); debug_helper(loc, 0, target, reset, format, type, bufSize, values);  }
    ...
    NewList :: proc "c" (list: uint, mode: Enum) { impl_NewList(list, mode) }
    EndList :: proc "c" () { impl_EndList() }
    CallList :: proc "c" (list: uint) { impl_CallList(list) }
    CallLists :: proc "c" (n: sizei, type: Enum, lists: rawptr) { impl_CallLists(n, type, lists) }
    DeleteLists :: proc "c" (list: uint, range: sizei) { impl_DeleteLists(list, range) }
    GenLists :: proc "c" (range: sizei) -> uint { return impl_GenLists(range) }
    ListBase :: proc "c" (base: uint) { impl_ListBase(base) }
    Begin :: proc "c" (mode: Enum) { impl_Begin(mode) }
    Bitmap :: proc "c" (width: sizei, height: sizei, xorig: float, yorig: float, xmove: float, ymove: float, bitmap: cstring) { impl_Bitmap(width, height, xorig, yorig, xmove, ymove, bitmap) }
    Color3b :: proc "c" (red: byte, green: byte, blue: byte) { impl_Color3b(red, green, blue) }
    Color3bv :: proc "c" (v: [^]byte) { impl_Color3bv(v) }
    Color3d :: proc "c" (red: double, green: double, blue: double) { impl_Color3d(red, green, blue) }
    Color3dv :: proc "c" (v: [^]double) { impl_Color3dv(v) }
    Color3f :: proc "c" (red: float, green: float, blue: float) { impl_Color3f(red, green, blue) }
    Color3fv :: proc "c" (v: [^]float) { impl_Color3fv(v) }
    Color3i :: proc "c" (red: int, green: int, blue: int) { impl_Color3i(red, green, blue) }
    Color3iv :: proc "c" (v: [^]int) { impl_Color3iv(v) }
    Color3s :: proc "c" (red: short, green: short, blue: short) { impl_Color3s(red, green, blue) }
    Color3sv :: proc "c" (v: [^]short) { impl_Color3sv(v) }
    Color3ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte) { impl_Color3ub(red, green, blue) }
    Color3ubv :: proc "c" (v: cstring) { impl_Color3ubv(v) }
    Color3ui :: proc "c" (red: uint, green: uint, blue: uint) { impl_Color3ui(red, green, blue) }
    Color3uiv :: proc "c" (v: [^]uint) { impl_Color3uiv(v) }
    Color3us :: proc "c" (red: ushort, green: ushort, blue: ushort) { impl_Color3us(red, green, blue) }
    Color3usv :: proc "c" (v: [^]ushort) { impl_Color3usv(v) }
    Color4b :: proc "c" (red: byte, green: byte, blue: byte, alpha: byte) { impl_Color4b(red, green, blue, alpha) }
    Color4bv :: proc "c" (v: [^]byte) { impl_Color4bv(v) }
    Color4d :: proc "c" (red: double, green: double, blue: double, alpha: double) { impl_Color4d(red, green, blue, alpha) }
    Color4dv :: proc "c" (v: [^]double) { impl_Color4dv(v) }
    Color4f :: proc "c" (red: float, green: float, blue: float, alpha: float) { impl_Color4f(red, green, blue, alpha) }
    Color4fv :: proc "c" (v: [^]float) { impl_Color4fv(v) }
    Color4i :: proc "c" (red: int, green: int, blue: int, alpha: int) { impl_Color4i(red, green, blue, alpha) }
    Color4iv :: proc "c" (v: [^]int) { impl_Color4iv(v) }
    Color4s :: proc "c" (red: short, green: short, blue: short, alpha: short) { impl_Color4s(red, green, blue, alpha) }
    Color4sv :: proc "c" (v: [^]short) { impl_Color4sv(v) }
    Color4ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte, alpha: ubyte) { impl_Color4ub(red, green, blue, alpha) }
    Color4ubv :: proc "c" (v: cstring) { impl_Color4ubv(v) }
    Color4ui :: proc "c" (red: uint, green: uint, blue: uint, alpha: uint) { impl_Color4ui(red, green, blue, alpha) }
    Color4uiv :: proc "c" (v: [^]uint) { impl_Color4uiv(v) }
    Color4us :: proc "c" (red: ushort, green: ushort, blue: ushort, alpha: ushort) { impl_Color4us(red, green, blue, alpha) }
    Color4usv :: proc "c" (v: [^]ushort) { impl_Color4usv(v) }
    EdgeFlag :: proc "c" (flag: boolean) { impl_EdgeFlag(flag) }
    EdgeFlagv :: proc "c" (flag: [^]boolean) { impl_EdgeFlagv(flag) }
    End :: proc "c" () { impl_End() }
    Indexd :: proc "c" (c: double) { impl_Indexd(c) }
    Indexdv :: proc "c" (c: [^]double) { impl_Indexdv(c) }
    Indexf :: proc "c" (c: float) { impl_Indexf(c) }
    Indexfv :: proc "c" (c: [^]float) { impl_Indexfv(c) }
    Indexi :: proc "c" (c: int) { impl_Indexi(c) }
    Indexiv :: proc "c" (c: [^]int) { impl_Indexiv(c) }
    Indexs :: proc "c" (c: short) { impl_Indexs(c) }
    Indexsv :: proc "c" (c: [^]short) { impl_Indexsv(c) }
    Normal3b :: proc "c" (nx: byte, ny: byte, nz: byte) { impl_Normal3b(nx, ny, nz) }
    Normal3bv :: proc "c" (v: [^]byte) { impl_Normal3bv(v) }
    Normal3d :: proc "c" (nx: double, ny: double, nz: double) { impl_Normal3d(nx, ny, nz) }
    Normal3dv :: proc "c" (v: [^]double) { impl_Normal3dv(v) }
    Normal3f :: proc "c" (nx: float, ny: float, nz: float) { impl_Normal3f(nx, ny, nz) }
    Normal3fv :: proc "c" (v: [^]float) { impl_Normal3fv(v) }
    Normal3i :: proc "c" (nx: int, ny: int, nz: int) { impl_Normal3i(nx, ny, nz) }
    Normal3iv :: proc "c" (v: [^]int) { impl_Normal3iv(v) }
    Normal3s :: proc "c" (nx: short, ny: short, nz: short) { impl_Normal3s(nx, ny, nz) }
    Normal3sv :: proc "c" (v: [^]short) { impl_Normal3sv(v) }
    RasterPos2d :: proc "c" (x: double, y: double) { impl_RasterPos2d(x, y) }
    RasterPos2dv :: proc "c" (v: [^]double) { impl_RasterPos2dv(v) }
    RasterPos2f :: proc "c" (x: float, y: float) { impl_RasterPos2f(x, y) }
    RasterPos2fv :: proc "c" (v: [^]float) { impl_RasterPos2fv(v) }
    RasterPos2i :: proc "c" (x: int, y: int) { impl_RasterPos2i(x, y) }
    RasterPos2iv :: proc "c" (v: [^]int) { impl_RasterPos2iv(v) }
    RasterPos2s :: proc "c" (x: short, y: short) { impl_RasterPos2s(x, y) }
    RasterPos2sv :: proc "c" (v: [^]short) { impl_RasterPos2sv(v) }
    RasterPos3d :: proc "c" (x: double, y: double, z: double) { impl_RasterPos3d(x, y, z) }
    RasterPos3dv :: proc "c" (v: [^]double) { impl_RasterPos3dv(v) }
    RasterPos3f :: proc "c" (x: float, y: float, z: float) { impl_RasterPos3f(x, y, z) }
    RasterPos3fv :: proc "c" (v: [^]float) { impl_RasterPos3fv(v) }
    RasterPos3i :: proc "c" (x: int, y: int, z: int) { impl_RasterPos3i(x, y, z) }
    RasterPos3iv :: proc "c" (v: [^]int) { impl_RasterPos3iv(v) }
    RasterPos3s :: proc "c" (x: short, y: short, z: short) { impl_RasterPos3s(x, y, z) }
    RasterPos3sv :: proc "c" (v: [^]short) { impl_RasterPos3sv(v) }
    RasterPos4d :: proc "c" (x: double, y: double, z: double, w: double) { impl_RasterPos4d(x, y, z, w) }
    RasterPos4dv :: proc "c" (v: [^]double) { impl_RasterPos4dv(v) }
    RasterPos4f :: proc "c" (x: float, y: float, z: float, w: float) { impl_RasterPos4f(x, y, z, w) }
    RasterPos4fv :: proc "c" (v: [^]float) { impl_RasterPos4fv(v) }
    RasterPos4i :: proc "c" (x: int, y: int, z: int, w: int) { impl_RasterPos4i(x, y, z, w) }
    RasterPos4iv :: proc "c" (v: [^]int) { impl_RasterPos4iv(v) }
    RasterPos4s :: proc "c" (x: short, y: short, z: short, w: short) { impl_RasterPos4s(x, y, z, w) }
    RasterPos4sv :: proc "c" (v: [^]short) { impl_RasterPos4sv(v) }
    Rectd :: proc "c" (x1: double, y1: double, x2: double, y2: double) { impl_Rectd(x1, y1, x2, y2) }
    Rectdv :: proc "c" (v1: [^]double, v2: [^]double) { impl_Rectdv(v1, v2) }
    Rectf :: proc "c" (x1: float, y1: float, x2: float, y2: float) { impl_Rectf(x1, y1, x2, y2) }
    Rectfv :: proc "c" (v1: [^]float, v2: [^]float) { impl_Rectfv(v1, v2) }
    Recti :: proc "c" (x1: int, y1: int, x2: int, y2: int) { impl_Recti(x1, y1, x2, y2) }
    Rectiv :: proc "c" (v1: [^]int, v2: [^]int) { impl_Rectiv(v1, v2) }
    Rects :: proc "c" (x1: short, y1: short, x2: short, y2: short) { impl_Rects(x1, y1, x2, y2) }
    Rectsv :: proc "c" (v1: [^]short, v2: [^]short) { impl_Rectsv(v1, v2) }
    TexCoord1d :: proc "c" (s: double) { impl_TexCoord1d(s) }
    TexCoord1dv :: proc "c" (v: [^]double) { impl_TexCoord1dv(v) }
    TexCoord1f :: proc "c" (s: float) { impl_TexCoord1f(s) }
    TexCoord1fv :: proc "c" (v: [^]float) { impl_TexCoord1fv(v) }
    TexCoord1i :: proc "c" (s: int) { impl_TexCoord1i(s) }
    TexCoord1iv :: proc "c" (v: [^]int) { impl_TexCoord1iv(v) }
    TexCoord1s :: proc "c" (s: short) { impl_TexCoord1s(s) }
    TexCoord1sv :: proc "c" (v: [^]short) { impl_TexCoord1sv(v) }
    TexCoord2d :: proc "c" (s: double, t: double) { impl_TexCoord2d(s, t) }
    TexCoord2dv :: proc "c" (v: [^]double) { impl_TexCoord2dv(v) }
    TexCoord2f :: proc "c" (s: float, t: float) { impl_TexCoord2f(s, t) }
    TexCoord2fv :: proc "c" (v: [^]float) { impl_TexCoord2fv(v) }
    TexCoord2i :: proc "c" (s: int, t: int) { impl_TexCoord2i(s, t) }
    TexCoord2iv :: proc "c" (v: [^]int) { impl_TexCoord2iv(v) }
    TexCoord2s :: proc "c" (s: short, t: short) { impl_TexCoord2s(s, t) }
    TexCoord2sv :: proc "c" (v: [^]short) { impl_TexCoord2sv(v) }
    TexCoord3d :: proc "c" (s: double, t: double, r: double) { impl_TexCoord3d(s, t, r) }
    TexCoord3dv :: proc "c" (v: [^]double) { impl_TexCoord3dv(v) }
    TexCoord3f :: proc "c" (s: float, t: float, r: float) { impl_TexCoord3f(s, t, r) }
    TexCoord3fv :: proc "c" (v: [^]float) { impl_TexCoord3fv(v) }
    TexCoord3i :: proc "c" (s: int, t: int, r: int) { impl_TexCoord3i(s, t, r) }
    TexCoord3iv :: proc "c" (v: [^]int) { impl_TexCoord3iv(v) }
    TexCoord3s :: proc "c" (s: short, t: short, r: short) { impl_TexCoord3s(s, t, r) }
    TexCoord3sv :: proc "c" (v: [^]short) { impl_TexCoord3sv(v) }
    TexCoord4d :: proc "c" (s: double, t: double, r: double, q: double) { impl_TexCoord4d(s, t, r, q) }
    TexCoord4dv :: proc "c" (v: [^]double) { impl_TexCoord4dv(v) }
    TexCoord4f :: proc "c" (s: float, t: float, r: float, q: float) { impl_TexCoord4f(s, t, r, q) }
    TexCoord4fv :: proc "c" (v: [^]float) { impl_TexCoord4fv(v) }
    TexCoord4i :: proc "c" (s: int, t: int, r: int, q: int) { impl_TexCoord4i(s, t, r, q) }
    TexCoord4iv :: proc "c" (v: [^]int) { impl_TexCoord4iv(v) }
    TexCoord4s :: proc "c" (s: short, t: short, r: short, q: short) { impl_TexCoord4s(s, t, r, q) }
    TexCoord4sv :: proc "c" (v: [^]short) { impl_TexCoord4sv(v) }
    Vertex2d :: proc "c" (x: double, y: double) { impl_Vertex2d(x, y) }
    Vertex2dv :: proc "c" (v: [^]double) { impl_Vertex2dv(v) }
    Vertex2f :: proc "c" (x: float, y: float) { impl_Vertex2f(x, y) }
    Vertex2fv :: proc "c" (v: [^]float) { impl_Vertex2fv(v) }
    Vertex2i :: proc "c" (x: int, y: int) { impl_Vertex2i(x, y) }
    Vertex2iv :: proc "c" (v: [^]int) { impl_Vertex2iv(v) }
    Vertex2s :: proc "c" (x: short, y: short) { impl_Vertex2s(x, y) }
    Vertex2sv :: proc "c" (v: [^]short) { impl_Vertex2sv(v) }
    Vertex3d :: proc "c" (x: double, y: double, z: double) { impl_Vertex3d(x, y, z) }
    Vertex3dv :: proc "c" (v: [^]double) { impl_Vertex3dv(v) }
    Vertex3f :: proc "c" (x: float, y: float, z: float) { impl_Vertex3f(x, y, z) }
    Vertex3fv :: proc "c" (v: [^]float) { impl_Vertex3fv(v) }
    Vertex3i :: proc "c" (x: int, y: int, z: int) { impl_Vertex3i(x, y, z) }
    Vertex3iv :: proc "c" (v: [^]int) { impl_Vertex3iv(v) }
    Vertex3s :: proc "c" (x: short, y: short, z: short) { impl_Vertex3s(x, y, z) }
    Vertex3sv :: proc "c" (v: [^]short) { impl_Vertex3sv(v) }
    Vertex4d :: proc "c" (x: double, y: double, z: double, w: double) { impl_Vertex4d(x, y, z, w) }
    Vertex4dv :: proc "c" (v: [^]double) { impl_Vertex4dv(v) }
    Vertex4f :: proc "c" (x: float, y: float, z: float, w: float) { impl_Vertex4f(x, y, z, w) }
    Vertex4fv :: proc "c" (v: [^]float) { impl_Vertex4fv(v) }
    Vertex4i :: proc "c" (x: int, y: int, z: int, w: int) { impl_Vertex4i(x, y, z, w) }
    Vertex4iv :: proc "c" (v: [^]int) { impl_Vertex4iv(v) }
    Vertex4s :: proc "c" (x: short, y: short, z: short, w: short) { impl_Vertex4s(x, y, z, w) }
    Vertex4sv :: proc "c" (v: [^]short) { impl_Vertex4sv(v) }
    ClipPlane :: proc "c" (plane: Enum, equation: [^]double) { impl_ClipPlane(plane, equation) }
    ColorMaterial :: proc "c" (face: Enum, mode: Enum) { impl_ColorMaterial(face, mode) }
    Fogf :: proc "c" (pname: Enum, param: float) { impl_Fogf(pname, param) }
    Fogfv :: proc "c" (pname: Enum, params: [^]float) { impl_Fogfv(pname, params) }
    Fogi :: proc "c" (pname: Enum, param: int) { impl_Fogi(pname, param) }
    Fogiv :: proc "c" (pname: Enum, params: [^]int) { impl_Fogiv(pname, params) }
    Lightf :: proc "c" (light: Enum, pname: Enum, param: float) { impl_Lightf(light, pname, param) }
    Lightfv :: proc "c" (light: Enum, pname: Enum, params: [^]float) { impl_Lightfv(light, pname, params) }
    Lighti :: proc "c" (light: Enum, pname: Enum, param: int) { impl_Lighti(light, pname, param) }
    Lightiv :: proc "c" (light: Enum, pname: Enum, params: [^]int) { impl_Lightiv(light, pname, params) }
    LightModelf :: proc "c" (pname: Enum, param: float) { impl_LightModelf(pname, param) }
    LightModelfv :: proc "c" (pname: Enum, params: [^]float) { impl_LightModelfv(pname, params) }
    LightModeli :: proc "c" (pname: Enum, param: int) { impl_LightModeli(pname, param) }
    LightModeliv :: proc "c" (pname: Enum, params: [^]int) { impl_LightModeliv(pname, params) }
    LineStipple :: proc "c" (factor: int, pattern: ushort) { impl_LineStipple(factor, pattern) }
    Materialf :: proc "c" (face: Enum, pname: Enum, param: float) { impl_Materialf(face, pname, param) }
    Materialfv :: proc "c" (face: Enum, pname: Enum, params: [^]float) { impl_Materialfv(face, pname, params) }
    Materiali :: proc "c" (face: Enum, pname: Enum, param: int) { impl_Materiali(face, pname, param) }
    Materialiv :: proc "c" (face: Enum, pname: Enum, params: [^]int) { impl_Materialiv(face, pname, params) }
    PolygonStipple :: proc "c" (mask: cstring) { impl_PolygonStipple(mask) }
    ShadeModel :: proc "c" (mode: Enum) { impl_ShadeModel(mode) }
    TexEnvf :: proc "c" (target: Enum, pname: Enum, param: float) { impl_TexEnvf(target, pname, param) }
    TexEnvfv :: proc "c" (target: Enum, pname: Enum, params: [^]float) { impl_TexEnvfv(target, pname, params) }
    TexEnvi :: proc "c" (target: Enum, pname: Enum, param: int) { impl_TexEnvi(target, pname, param) }
    TexEnviv :: proc "c" (target: Enum, pname: Enum, params: [^]int) { impl_TexEnviv(target, pname, params) }
    TexGend :: proc "c" (coord: Enum, pname: Enum, param: double) { impl_TexGend(coord, pname, param) }
    TexGendv :: proc "c" (coord: Enum, pname: Enum, params: [^]double) { impl_TexGendv(coord, pname, params) }
    TexGenf :: proc "c" (coord: Enum, pname: Enum, param: float) { impl_TexGenf(coord, pname, param) }
    TexGenfv :: proc "c" (coord: Enum, pname: Enum, params: [^]float) { impl_TexGenfv(coord, pname, params) }
    TexGeni :: proc "c" (coord: Enum, pname: Enum, param: int) { impl_TexGeni(coord, pname, param) }
    TexGeniv :: proc "c" (coord: Enum, pname: Enum, params: [^]int) { impl_TexGeniv(coord, pname, params) }
    FeedbackBuffer :: proc "c" (size: sizei, type: Enum, buffer: [^]float) { impl_FeedbackBuffer(size, type, buffer) }
    SelectBuffer :: proc "c" (size: sizei, buffer: [^]uint) { impl_SelectBuffer(size, buffer) }
    RenderMode :: proc "c" (mode: Enum) -> int { return impl_RenderMode(mode) }
    InitNames :: proc "c" () { impl_InitNames() }
    LoadName :: proc "c" (name: uint) { impl_LoadName(name) }
    PassThrough :: proc "c" (token: float) { impl_PassThrough(token) }
    PopName :: proc "c" () { impl_PopName() }
    PushName :: proc "c" (name: uint) { impl_PushName(name) }
    ClearAccum :: proc "c" (red: float, green: float, blue: float, alpha: float) { impl_ClearAccum(red, green, blue, alpha) }
    ClearIndex :: proc "c" (c: float) { impl_ClearIndex(c) }
    IndexMask :: proc "c" (mask: uint) { impl_IndexMask(mask) }
    Accum :: proc "c" (op: Enum, value: float) { impl_Accum(op, value) }
    PopAttrib :: proc "c" () { impl_PopAttrib() }
    PushAttrib :: proc "c" (mask: bitfield) { impl_PushAttrib(mask) }
    Map1d :: proc "c" (target: Enum, u1: double, u2: double, stride: int, order: int, points: [^]double) { impl_Map1d(target, u1, u2, stride, order, points) }
    Map1f :: proc "c" (target: Enum, u1: float, u2: float, stride: int, order: int, points: [^]float) { impl_Map1f(target, u1, u2, stride, order, points) }
    Map2d :: proc "c" (target: Enum, u1: double, u2: double, ustride: int, uorder: int, v1: double, v2: double, vstride: int, vorder: int, points: [^]double) { impl_Map2d(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points) }
    Map2f :: proc "c" (target: Enum, u1: float, u2: float, ustride: int, uorder: int, v1: float, v2: float, vstride: int, vorder: int, points: [^]float) { impl_Map2f(target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points) }
    MapGrid1d :: proc "c" (un: int, u1: double, u2: double) { impl_MapGrid1d(un, u1, u2) }
    MapGrid1f :: proc "c" (un: int, u1: float, u2: float) { impl_MapGrid1f(un, u1, u2) }
    MapGrid2d :: proc "c" (un: int, u1: double, u2: double, vn: int, v1: double, v2: double) { impl_MapGrid2d(un, u1, u2, vn, v1, v2) }
    MapGrid2f :: proc "c" (un: int, u1: float, u2: float, vn: int, v1: float, v2: float) { impl_MapGrid2f(un, u1, u2, vn, v1, v2) }
    EvalCoord1d :: proc "c" (u: double) { impl_EvalCoord1d(u) }
    EvalCoord1dv :: proc "c" (u: [^]double) { impl_EvalCoord1dv(u) }
    EvalCoord1f :: proc "c" (u: float) { impl_EvalCoord1f(u) }
    EvalCoord1fv :: proc "c" (u: [^]float) { impl_EvalCoord1fv(u) }
    EvalCoord2d :: proc "c" (u: double, v: double) { impl_EvalCoord2d(u, v) }
    EvalCoord2dv :: proc "c" (u: [^]double) { impl_EvalCoord2dv(u) }
    EvalCoord2f :: proc "c" (u: float, v: float) { impl_EvalCoord2f(u, v) }
    EvalCoord2fv :: proc "c" (u: [^]float) { impl_EvalCoord2fv(u) }
    EvalMesh1 :: proc "c" (mode: Enum, i1: int, i2: int) { impl_EvalMesh1(mode, i1, i2) }
    EvalPoint1 :: proc "c" (i: int) { impl_EvalPoint1(i) }
    EvalMesh2 :: proc "c" (mode: Enum, i1: int, i2: int, j1: int, j2: int) { impl_EvalMesh2(mode, i1, i2, j1, j2) }
    EvalPoint2 :: proc "c" (i: int, j: int) { impl_EvalPoint2(i, j) }
    AlphaFunc :: proc "c" (func: Enum, ref: float) { impl_AlphaFunc(func, ref) }
    PixelZoom :: proc "c" (xfactor: float, yfactor: float) { impl_PixelZoom(xfactor, yfactor) }
    PixelTransferf :: proc "c" (pname: Enum, param: float) { impl_PixelTransferf(pname, param) }
    PixelTransferi :: proc "c" (pname: Enum, param: int) { impl_PixelTransferi(pname, param) }
    PixelMapfv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]float) { impl_PixelMapfv(_map, mapsize, values) }
    PixelMapuiv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]uint) { impl_PixelMapuiv(_map, mapsize, values) }
    PixelMapusv :: proc "c" (_map: Enum, mapsize: sizei, values: [^]ushort) { impl_PixelMapusv(_map, mapsize, values) }
    CopyPixels :: proc "c" (x: int, y: int, width: sizei, height: sizei, type: Enum) { impl_CopyPixels(x, y, width, height, type) }
    DrawPixels :: proc "c" (width: sizei, height: sizei, format: Enum, type: Enum, pixels: rawptr) { impl_DrawPixels(width, height, format, type, pixels) }
    GetClipPlane :: proc "c" (plane: Enum, equation: [^]double) { impl_GetClipPlane(plane, equation) }
    GetLightfv :: proc "c" (light: Enum, pname: Enum, params: [^]float) { impl_GetLightfv(light, pname, params) }
    GetLightiv :: proc "c" (light: Enum, pname: Enum, params: [^]int) { impl_GetLightiv(light, pname, params) }
    GetMapdv :: proc "c" (target: Enum, query: Enum, v: [^]double) { impl_GetMapdv(target, query, v) }
    GetMapfv :: proc "c" (target: Enum, query: Enum, v: [^]float) { impl_GetMapfv(target, query, v) }
    GetMapiv :: proc "c" (target: Enum, query: Enum, v: [^]int) { impl_GetMapiv(target, query, v) }
    GetMaterialfv :: proc "c" (face: Enum, pname: Enum, params: [^]float) { impl_GetMaterialfv(face, pname, params) }
    GetMaterialiv :: proc "c" (face: Enum, pname: Enum, params: [^]int) { impl_GetMaterialiv(face, pname, params) }
    GetPixelMapfv :: proc "c" (_map: Enum, values: [^]float) { impl_GetPixelMapfv(_map, values) }
    GetPixelMapuiv :: proc "c" (_map: Enum, values: [^]uint) { impl_GetPixelMapuiv(_map, values) }
    GetPixelMapusv :: proc "c" (_map: Enum, values: [^]ushort) { impl_GetPixelMapusv(_map, values) }
    GetPolygonStipple :: proc "c" (mask: [^]ubyte) { impl_GetPolygonStipple(mask) }
    GetTexEnvfv :: proc "c" (target: Enum, pname: Enum, params: [^]float) { impl_GetTexEnvfv(target, pname, params) }
    GetTexEnviv :: proc "c" (target: Enum, pname: Enum, params: [^]int) { impl_GetTexEnviv(target, pname, params) }
    GetTexGendv :: proc "c" (coord: Enum, pname: Enum, params: [^]double) { impl_GetTexGendv(coord, pname, params) }
    GetTexGenfv :: proc "c" (coord: Enum, pname: Enum, params: [^]float) { impl_GetTexGenfv(coord, pname, params) }
    GetTexGeniv :: proc "c" (coord: Enum, pname: Enum, params: [^]int) { impl_GetTexGeniv(coord, pname, params) }
    IsList :: proc "c" (list: uint) -> boolean { return impl_IsList(list) }
    Frustum :: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double) { impl_Frustum(left, right, bottom, top, zNear, zFar) }
    LoadIdentity :: proc "c" () { impl_LoadIdentity() }
    LoadMatrixf :: proc "c" (m: [^]float) { impl_LoadMatrixf(m) }
    LoadMatrixd :: proc "c" (m: [^]double) { impl_LoadMatrixd(m) }
    MatrixMode :: proc "c" (mode: Enum) { impl_MatrixMode(mode) }
    MultMatrixf :: proc "c" (m: [^]float) { impl_MultMatrixf(m) }
    MultMatrixd :: proc "c" (m: [^]double) { impl_MultMatrixd(m) }
    Ortho :: proc "c" (left: double, right: double, bottom: double, top: double, zNear: double, zFar: double) { impl_Ortho(left, right, bottom, top, zNear, zFar) }
    PopMatrix :: proc "c" () { impl_PopMatrix() }
    PushMatrix :: proc "c" () { impl_PushMatrix() }
    Rotated :: proc "c" (angle: double, x: double, y: double, z: double) { impl_Rotated(angle, x, y, z) }
    Rotatef :: proc "c" (angle: float, x: float, y: float, z: float) { impl_Rotatef(angle, x, y, z) }
    Scaled :: proc "c" (x: double, y: double, z: double) { impl_Scaled(x, y, z) }
    Scalef :: proc "c" (x: float, y: float, z: float) { impl_Scalef(x, y, z) }
    Translated :: proc "c" (x: double, y: double, z: double) { impl_Translated(x, y, z) }
    Translatef :: proc "c" (x: float, y: float, z: float) { impl_Translatef(x, y, z) }
    ...
    ArrayElement :: proc "c" (i: int) { impl_ArrayElement(i) }
    ColorPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr) { impl_ColorPointer(size, type, stride, pointer) }
    DisableClientState :: proc "c" (array: Enum) { impl_DisableClientState(array) }
    EdgeFlagPointer :: proc "c" (stride: sizei, pointer: rawptr) { impl_EdgeFlagPointer(stride, pointer) }
    EnableClientState :: proc "c" (array: Enum) { impl_EnableClientState(array) }
    IndexPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr) { impl_IndexPointer(type, stride, pointer) }
    InterleavedArrays :: proc "c" (format: Enum, stride: sizei, pointer: rawptr) { impl_InterleavedArrays(format, stride, pointer) }
    NormalPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr) { impl_NormalPointer(type, stride, pointer) }
    TexCoordPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr) { impl_TexCoordPointer(size, type, stride, pointer) }
    VertexPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr) { impl_VertexPointer(size, type, stride, pointer) }
    AreTexturesResident :: proc "c" (n: sizei, textures: [^]uint, residences: [^]boolean) -> boolean { return impl_AreTexturesResident(n, textures, residences) }
    PrioritizeTextures :: proc "c" (n: sizei, textures: [^]uint, priorities: [^]float) { impl_PrioritizeTextures(n, textures, priorities) }
    Indexub :: proc "c" (c: ubyte) { impl_Indexub(c) }
    Indexubv :: proc "c" (c: cstring) { impl_Indexubv(c) }
    PopClientAttrib :: proc "c" () { impl_PopClientAttrib() }
    PushClientAttrib :: proc "c" (mask: bitfield) { impl_PushClientAttrib(mask) }
    ...
    ClientActiveTexture :: proc "c" (texture: Enum) { impl_ClientActiveTexture(texture) }
    MultiTexCoord1d :: proc "c" (target: Enum, s: double) { impl_MultiTexCoord1d(target, s) }
    MultiTexCoord1dv :: proc "c" (target: Enum, v: [^]double) { impl_MultiTexCoord1dv(target, v) }
    MultiTexCoord1f :: proc "c" (target: Enum, s: float) { impl_MultiTexCoord1f(target, s) }
    MultiTexCoord1fv :: proc "c" (target: Enum, v: [^]float) { impl_MultiTexCoord1fv(target, v) }
    MultiTexCoord1i :: proc "c" (target: Enum, s: int) { impl_MultiTexCoord1i(target, s) }
    MultiTexCoord1iv :: proc "c" (target: Enum, v: [^]int) { impl_MultiTexCoord1iv(target, v) }
    MultiTexCoord1s :: proc "c" (target: Enum, s: short) { impl_MultiTexCoord1s(target, s) }
    MultiTexCoord1sv :: proc "c" (target: Enum, v: [^]short) { impl_MultiTexCoord1sv(target, v) }
    MultiTexCoord2d :: proc "c" (target: Enum, s: double, t: double) { impl_MultiTexCoord2d(target, s, t) }
    MultiTexCoord2dv :: proc "c" (target: Enum, v: [^]double) { impl_MultiTexCoord2dv(target, v) }
    MultiTexCoord2f :: proc "c" (target: Enum, s: float, t: float) { impl_MultiTexCoord2f(target, s, t) }
    MultiTexCoord2fv :: proc "c" (target: Enum, v: [^]float) { impl_MultiTexCoord2fv(target, v) }
    MultiTexCoord2i :: proc "c" (target: Enum, s: int, t: int) { impl_MultiTexCoord2i(target, s, t) }
    MultiTexCoord2iv :: proc "c" (target: Enum, v: [^]int) { impl_MultiTexCoord2iv(target, v) }
    MultiTexCoord2s :: proc "c" (target: Enum, s: short, t: short) { impl_MultiTexCoord2s(target, s, t) }
    MultiTexCoord2sv :: proc "c" (target: Enum, v: [^]short) { impl_MultiTexCoord2sv(target, v) }
    MultiTexCoord3d :: proc "c" (target: Enum, s: double, t: double, r: double) { impl_MultiTexCoord3d(target, s, t, r) }
    MultiTexCoord3dv :: proc "c" (target: Enum, v: [^]double) { impl_MultiTexCoord3dv(target, v) }
    MultiTexCoord3f :: proc "c" (target: Enum, s: float, t: float, r: float) { impl_MultiTexCoord3f(target, s, t, r) }
    MultiTexCoord3fv :: proc "c" (target: Enum, v: [^]float) { impl_MultiTexCoord3fv(target, v) }
    MultiTexCoord3i :: proc "c" (target: Enum, s: int, t: int, r: int) { impl_MultiTexCoord3i(target, s, t, r) }
    MultiTexCoord3iv :: proc "c" (target: Enum, v: [^]int) { impl_MultiTexCoord3iv(target, v) }
    MultiTexCoord3s :: proc "c" (target: Enum, s: short, t: short, r: short) { impl_MultiTexCoord3s(target, s, t, r) }
    MultiTexCoord3sv :: proc "c" (target: Enum, v: [^]short) { impl_MultiTexCoord3sv(target, v) }
    MultiTexCoord4d :: proc "c" (target: Enum, s: double, t: double, r: double, q: double) { impl_MultiTexCoord4d(target, s, t, r, q) }
    MultiTexCoord4dv :: proc "c" (target: Enum, v: [^]double) { impl_MultiTexCoord4dv(target, v) }
    MultiTexCoord4f :: proc "c" (target: Enum, s: float, t: float, r: float, q: float) { impl_MultiTexCoord4f(target, s, t, r, q) }
    MultiTexCoord4fv :: proc "c" (target: Enum, v: [^]float) { impl_MultiTexCoord4fv(target, v) }
    MultiTexCoord4i :: proc "c" (target: Enum, s: int, t: int, r: int, q: int) { impl_MultiTexCoord4i(target, s, t, r, q) }
    MultiTexCoord4iv :: proc "c" (target: Enum, v: [^]int) { impl_MultiTexCoord4iv(target, v) }
    MultiTexCoord4s :: proc "c" (target: Enum, s: short, t: short, r: short, q: short) { impl_MultiTexCoord4s(target, s, t, r, q) }
    MultiTexCoord4sv :: proc "c" (target: Enum, v: [^]short) { impl_MultiTexCoord4sv(target, v) }
    LoadTransposeMatrixf :: proc "c" (m: [^]float) { impl_LoadTransposeMatrixf(m) }
    LoadTransposeMatrixd :: proc "c" (m: [^]double) { impl_LoadTransposeMatrixd(m) }
    MultTransposeMatrixf :: proc "c" (m: [^]float) { impl_MultTransposeMatrixf(m) }
    MultTransposeMatrixd :: proc "c" (m: [^]double) { impl_MultTransposeMatrixd(m) }
    ...
    FogCoordf :: proc "c" (coord: float) { impl_FogCoordf(coord) }
    FogCoordfv :: proc "c" (coord: [^]float) { impl_FogCoordfv(coord) }
    FogCoordd :: proc "c" (coord: double) { impl_FogCoordd(coord) }
    FogCoorddv :: proc "c" (coord: [^]double) { impl_FogCoorddv(coord) }
    FogCoordPointer :: proc "c" (type: Enum, stride: sizei, pointer: rawptr) { impl_FogCoordPointer(type, stride, pointer) }
    SecondaryColor3b :: proc "c" (red: byte, green: byte, blue: byte) { impl_SecondaryColor3b(red, green, blue) }
    SecondaryColor3bv :: proc "c" (v: [^]byte) { impl_SecondaryColor3bv(v) }
    SecondaryColor3d :: proc "c" (red: double, green: double, blue: double) { impl_SecondaryColor3d(red, green, blue) }
    SecondaryColor3dv :: proc "c" (v: [^]double) { impl_SecondaryColor3dv(v) }
    SecondaryColor3f :: proc "c" (red: float, green: float, blue: float) { impl_SecondaryColor3f(red, green, blue) }
    SecondaryColor3fv :: proc "c" (v: [^]float) { impl_SecondaryColor3fv(v) }
    SecondaryColor3i :: proc "c" (red: int, green: int, blue: int) { impl_SecondaryColor3i(red, green, blue) }
    SecondaryColor3iv :: proc "c" (v: [^]int) { impl_SecondaryColor3iv(v) }
    SecondaryColor3s :: proc "c" (red: short, green: short, blue: short) { impl_SecondaryColor3s(red, green, blue) }
    SecondaryColor3sv :: proc "c" (v: [^]short) { impl_SecondaryColor3sv(v) }
    SecondaryColor3ub :: proc "c" (red: ubyte, green: ubyte, blue: ubyte) { impl_SecondaryColor3ub(red, green, blue) }
    SecondaryColor3ubv :: proc "c" (v: cstring) { impl_SecondaryColor3ubv(v) }
    SecondaryColor3ui :: proc "c" (red: uint, green: uint, blue: uint) { impl_SecondaryColor3ui(red, green, blue) }
    SecondaryColor3uiv :: proc "c" (v: [^]uint) { impl_SecondaryColor3uiv(v) }
    SecondaryColor3us :: proc "c" (red: ushort, green: ushort, blue: ushort) { impl_SecondaryColor3us(red, green, blue) }
    SecondaryColor3usv :: proc "c" (v: [^]ushort) { impl_SecondaryColor3usv(v) }
    SecondaryColorPointer :: proc "c" (size: int, type: Enum, stride: sizei, pointer: rawptr) { impl_SecondaryColorPointer(size, type, stride, pointer) }
    WindowPos2d :: proc "c" (x: double, y: double) { impl_WindowPos2d(x, y) }
    WindowPos2dv :: proc "c" (v: [^]double) { impl_WindowPos2dv(v) }
    WindowPos2f :: proc "c" (x: float, y: float) { impl_WindowPos2f(x, y) }
    WindowPos2fv :: proc "c" (v: [^]float) { impl_WindowPos2fv(v) }
    WindowPos2i :: proc "c" (x: int, y: int) { impl_WindowPos2i(x, y) }
    WindowPos2iv :: proc "c" (v: [^]int) { impl_WindowPos2iv(v) }
    WindowPos2s :: proc "c" (x: short, y: short) { impl_WindowPos2s(x, y) }
    WindowPos2sv :: proc "c" (v: [^]short) { impl_WindowPos2sv(v) }
    WindowPos3d :: proc "c" (x: double, y: double, z: double) { impl_WindowPos3d(x, y, z) }
    WindowPos3dv :: proc "c" (v: [^]double) { impl_WindowPos3dv(v) }
    WindowPos3f :: proc "c" (x: float, y: float, z: float) { impl_WindowPos3f(x, y, z) }
    WindowPos3fv :: proc "c" (v: [^]float) { impl_WindowPos3fv(v) }
    WindowPos3i :: proc "c" (x: int, y: int, z: int) { impl_WindowPos3i(x, y, z) }
    WindowPos3iv :: proc "c" (v: [^]int) { impl_WindowPos3iv(v) }
    WindowPos3s :: proc "c" (x: short, y: short, z: short) { impl_WindowPos3s(x, y, z) }
    WindowPos3sv :: proc "c" (v: [^]short) { impl_WindowPos3sv(v) }
    ...
    VertexAttribPointer :: proc "c" (index: uint, size: int, type: Enum, normalized: boolean, stride: sizei, pointer: rawptr) { impl_VertexAttribPointer(index, size, type, normalized, stride, pointer) }
    ...
    VertexP2ui :: proc "c" (type: Enum, value: uint) { impl_VertexP2ui(type, value) }
    VertexP2uiv :: proc "c" (type: Enum, value: [^]uint) { impl_VertexP2uiv(type, value) }
    VertexP3ui :: proc "c" (type: Enum, value: uint) { impl_VertexP3ui(type, value) }
    VertexP3uiv :: proc "c" (type: Enum, value: [^]uint) { impl_VertexP3uiv(type, value) }
    VertexP4ui :: proc "c" (type: Enum, value: uint) { impl_VertexP4ui(type, value) }
    VertexP4uiv :: proc "c" (type: Enum, value: [^]uint) { impl_VertexP4uiv(type, value) }
    TexCoordP1ui :: proc "c" (type: Enum, coords: uint) { impl_TexCoordP1ui(type, coords) }
    TexCoordP1uiv :: proc "c" (type: Enum, coords: [^]uint) { impl_TexCoordP1uiv(type, coords) }
    TexCoordP2ui :: proc "c" (type: Enum, coords: uint) { impl_TexCoordP2ui(type, coords) }
    TexCoordP2uiv :: proc "c" (type: Enum, coords: [^]uint) { impl_TexCoordP2uiv(type, coords) }
    TexCoordP3ui :: proc "c" (type: Enum, coords: uint) { impl_TexCoordP3ui(type, coords) }
    TexCoordP3uiv :: proc "c" (type: Enum, coords: [^]uint) { impl_TexCoordP3uiv(type, coords) }
    TexCoordP4ui :: proc "c" (type: Enum, coords: uint) { impl_TexCoordP4ui(type, coords) }
    TexCoordP4uiv :: proc "c" (type: Enum, coords: [^]uint) { impl_TexCoordP4uiv(type, coords) }
    MultiTexCoordP1ui :: proc "c" (texture: Enum, type: Enum, coords: uint) { impl_MultiTexCoordP1ui(texture, type, coords) }
    MultiTexCoordP1uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint) { impl_MultiTexCoordP1uiv(texture, type, coords) }
    MultiTexCoordP2ui :: proc "c" (texture: Enum, type: Enum, coords: uint) { impl_MultiTexCoordP2ui(texture, type, coords) }
    MultiTexCoordP2uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint) { impl_MultiTexCoordP2uiv(texture, type, coords) }
    MultiTexCoordP3ui :: proc "c" (texture: Enum, type: Enum, coords: uint) { impl_MultiTexCoordP3ui(texture, type, coords) }
    MultiTexCoordP3uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint) { impl_MultiTexCoordP3uiv(texture, type, coords) }
    MultiTexCoordP4ui :: proc "c" (texture: Enum, type: Enum, coords: uint) { impl_MultiTexCoordP4ui(texture, type, coords) }
    MultiTexCoordP4uiv :: proc "c" (texture: Enum, type: Enum, coords: [^]uint) { impl_MultiTexCoordP4uiv(texture, type, coords) }
    NormalP3ui :: proc "c" (type: Enum, coords: uint) { impl_NormalP3ui(type, coords) }
    NormalP3uiv :: proc "c" (type: Enum, coords: [^]uint) { impl_NormalP3uiv(type, coords) }
    ColorP3ui :: proc "c" (type: Enum, color: uint) { impl_ColorP3ui(type, color) }
    ColorP3uiv :: proc "c" (type: Enum, color: [^]uint) { impl_ColorP3uiv(type, color) }
    ColorP4ui :: proc "c" (type: Enum, color: uint) { impl_ColorP4ui(type, color) }
    ColorP4uiv :: proc "c" (type: Enum, color: [^]uint) { impl_ColorP4uiv(type, color) }
    SecondaryColorP3ui :: proc "c" (type: Enum, color: uint) { impl_SecondaryColorP3ui(type, color) }
    SecondaryColorP3uiv :: proc "c" (type: Enum, color: [^]uint) { impl_SecondaryColorP3uiv(type, color) }
    ...
    GetnMapdv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]double) { impl_GetnMapdv(target, query, bufSize, v) }
    GetnMapfv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]float) { impl_GetnMapfv(target, query, bufSize, v) }
    GetnMapiv :: proc "c" (target: Enum, query: Enum, bufSize: sizei, v: [^]int) { impl_GetnMapiv(target, query, bufSize, v) }
    GetnPixelMapfv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]float) { impl_GetnPixelMapfv(_map, bufSize, values) }
    GetnPixelMapuiv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]uint) { impl_GetnPixelMapuiv(_map, bufSize, values) }
    GetnPixelMapusv :: proc "c" (_map: Enum, bufSize: sizei, values: [^]ushort) { impl_GetnPixelMapusv(_map, bufSize, values) }
    GetnPolygonStipple :: proc "c" (bufSize: sizei, pattern: [^]ubyte) { impl_GetnPolygonStipple(bufSize, pattern) }
    GetnColorTable :: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, table: rawptr) { impl_GetnColorTable(target, format, type, bufSize, table) }
    GetnConvolutionFilter :: proc "c" (target: Enum, format: Enum, type: Enum, bufSize: sizei, image: rawptr) { impl_GetnConvolutionFilter(target, format, type, bufSize, image) }
    GetnSeparableFilter :: proc "c" (target: Enum, format: Enum, type: Enum, rowBufSize: sizei, row: rawptr, columnBufSize: sizei, column: rawptr, span: rawptr) { impl_GetnSeparableFilter(target, format, type, rowBufSize, row, columnBufSize, column, span) }
    GetnHistogram :: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr) { impl_GetnHistogram(target, reset, format, type, bufSize, values) }
    GetnMinmax :: proc "c" (target: Enum, reset: boolean, format: Enum, type: Enum, bufSize: sizei, values: rawptr) { impl_GetnMinmax(target, reset, format, type, bufSize, values) }
...
load_gl :: proc(set_proc_address: Set_Proc_Address) {
    ...
    set_proc_address(&impl_NewList, "glNewList")
    set_proc_address(&impl_EndList, "glEndList")
    set_proc_address(&impl_CallList, "glCallList")
    set_proc_address(&impl_CallLists, "glCallLists")
    set_proc_address(&impl_DeleteLists, "glDeleteLists")
    set_proc_address(&impl_GenLists, "glGenLists")
    set_proc_address(&impl_ListBase, "glListBase")
    set_proc_address(&impl_Begin, "glBegin")
    set_proc_address(&impl_Bitmap, "glBitmap")
    set_proc_address(&impl_Color3b, "glColor3b")
    set_proc_address(&impl_Color3bv, "glColor3bv")
    set_proc_address(&impl_Color3d, "glColor3d")
    set_proc_address(&impl_Color3dv, "glColor3dv")
    set_proc_address(&impl_Color3f, "glColor3f")
    set_proc_address(&impl_Color3fv, "glColor3fv")
    set_proc_address(&impl_Color3i, "glColor3i")
    set_proc_address(&impl_Color3iv, "glColor3iv")
    set_proc_address(&impl_Color3s, "glColor3s")
    set_proc_address(&impl_Color3sv, "glColor3sv")
    set_proc_address(&impl_Color3ub, "glColor3ub")
    set_proc_address(&impl_Color3ubv, "glColor3ubv")
    set_proc_address(&impl_Color3ui, "glColor3ui")
    set_proc_address(&impl_Color3uiv, "glColor3uiv")
    set_proc_address(&impl_Color3us, "glColor3us")
    set_proc_address(&impl_Color3usv, "glColor3usv")
    set_proc_address(&impl_Color4b, "glColor4b")
    set_proc_address(&impl_Color4bv, "glColor4bv")
    set_proc_address(&impl_Color4d, "glColor4d")
    set_proc_address(&impl_Color4dv, "glColor4dv")
    set_proc_address(&impl_Color4f, "glColor4f")
    set_proc_address(&impl_Color4fv, "glColor4fv")
    set_proc_address(&impl_Color4i, "glColor4i")
    set_proc_address(&impl_Color4iv, "glColor4iv")
    set_proc_address(&impl_Color4s, "glColor4s")
    set_proc_address(&impl_Color4sv, "glColor4sv")
    set_proc_address(&impl_Color4ub, "glColor4ub")
    set_proc_address(&impl_Color4ubv, "glColor4ubv")
    set_proc_address(&impl_Color4ui, "glColor4ui")
    set_proc_address(&impl_Color4uiv, "glColor4uiv")
    set_proc_address(&impl_Color4us, "glColor4us")
    set_proc_address(&impl_Color4usv, "glColor4usv")
    set_proc_address(&impl_EdgeFlag, "glEdgeFlag")
    set_proc_address(&impl_EdgeFlagv, "glEdgeFlagv")
    set_proc_address(&impl_End, "glEnd")
    set_proc_address(&impl_Indexd, "glIndexd")
    set_proc_address(&impl_Indexdv, "glIndexdv")
    set_proc_address(&impl_Indexf, "glIndexf")
    set_proc_address(&impl_Indexfv, "glIndexfv")
    set_proc_address(&impl_Indexi, "glIndexi")
    set_proc_address(&impl_Indexiv, "glIndexiv")
    set_proc_address(&impl_Indexs, "glIndexs")
    set_proc_address(&impl_Indexsv, "glIndexsv")
    set_proc_address(&impl_Normal3b, "glNormal3b")
    set_proc_address(&impl_Normal3bv, "glNormal3bv")
    set_proc_address(&impl_Normal3d, "glNormal3d")
    set_proc_address(&impl_Normal3dv, "glNormal3dv")
    set_proc_address(&impl_Normal3f, "glNormal3f")
    set_proc_address(&impl_Normal3fv, "glNormal3fv")
    set_proc_address(&impl_Normal3i, "glNormal3i")
    set_proc_address(&impl_Normal3iv, "glNormal3iv")
    set_proc_address(&impl_Normal3s, "glNormal3s")
    set_proc_address(&impl_Normal3sv, "glNormal3sv")
    set_proc_address(&impl_RasterPos2d, "glRasterPos2d")
    set_proc_address(&impl_RasterPos2dv, "glRasterPos2dv")
    set_proc_address(&impl_RasterPos2f, "glRasterPos2f")
    set_proc_address(&impl_RasterPos2fv, "glRasterPos2fv")
    set_proc_address(&impl_RasterPos2i, "glRasterPos2i")
    set_proc_address(&impl_RasterPos2iv, "glRasterPos2iv")
    set_proc_address(&impl_RasterPos2s, "glRasterPos2s")
    set_proc_address(&impl_RasterPos2sv, "glRasterPos2sv")
    set_proc_address(&impl_RasterPos3d, "glRasterPos3d")
    set_proc_address(&impl_RasterPos3dv, "glRasterPos3dv")
    set_proc_address(&impl_RasterPos3f, "glRasterPos3f")
    set_proc_address(&impl_RasterPos3fv, "glRasterPos3fv")
    set_proc_address(&impl_RasterPos3i, "glRasterPos3i")
    set_proc_address(&impl_RasterPos3iv, "glRasterPos3iv")
    set_proc_address(&impl_RasterPos3s, "glRasterPos3s")
    set_proc_address(&impl_RasterPos3sv, "glRasterPos3sv")
    set_proc_address(&impl_RasterPos4d, "glRasterPos4d")
    set_proc_address(&impl_RasterPos4dv, "glRasterPos4dv")
    set_proc_address(&impl_RasterPos4f, "glRasterPos4f")
    set_proc_address(&impl_RasterPos4fv, "glRasterPos4fv")
    set_proc_address(&impl_RasterPos4i, "glRasterPos4i")
    set_proc_address(&impl_RasterPos4iv, "glRasterPos4iv")
    set_proc_address(&impl_RasterPos4s, "glRasterPos4s")
    set_proc_address(&impl_RasterPos4sv, "glRasterPos4sv")
    set_proc_address(&impl_Rectd, "glRectd")
    set_proc_address(&impl_Rectdv, "glRectdv")
    set_proc_address(&impl_Rectf, "glRectf")
    set_proc_address(&impl_Rectfv, "glRectfv")
    set_proc_address(&impl_Recti, "glRecti")
    set_proc_address(&impl_Rectiv, "glRectiv")
    set_proc_address(&impl_Rects, "glRects")
    set_proc_address(&impl_Rectsv, "glRectsv")
    set_proc_address(&impl_TexCoord1d, "glTexCoord1d")
    set_proc_address(&impl_TexCoord1dv, "glTexCoord1dv")
    set_proc_address(&impl_TexCoord1f, "glTexCoord1f")
    set_proc_address(&impl_TexCoord1fv, "glTexCoord1fv")
    set_proc_address(&impl_TexCoord1i, "glTexCoord1i")
    set_proc_address(&impl_TexCoord1iv, "glTexCoord1iv")
    set_proc_address(&impl_TexCoord1s, "glTexCoord1s")
    set_proc_address(&impl_TexCoord1sv, "glTexCoord1sv")
    set_proc_address(&impl_TexCoord2d, "glTexCoord2d")
    set_proc_address(&impl_TexCoord2dv, "glTexCoord2dv")
    set_proc_address(&impl_TexCoord2f, "glTexCoord2f")
    set_proc_address(&impl_TexCoord2fv, "glTexCoord2fv")
    set_proc_address(&impl_TexCoord2i, "glTexCoord2i")
    set_proc_address(&impl_TexCoord2iv, "glTexCoord2iv")
    set_proc_address(&impl_TexCoord2s, "glTexCoord2s")
    set_proc_address(&impl_TexCoord2sv, "glTexCoord2sv")
    set_proc_address(&impl_TexCoord3d, "glTexCoord3d")
    set_proc_address(&impl_TexCoord3dv, "glTexCoord3dv")
    set_proc_address(&impl_TexCoord3f, "glTexCoord3f")
    set_proc_address(&impl_TexCoord3fv, "glTexCoord3fv")
    set_proc_address(&impl_TexCoord3i, "glTexCoord3i")
    set_proc_address(&impl_TexCoord3iv, "glTexCoord3iv")
    set_proc_address(&impl_TexCoord3s, "glTexCoord3s")
    set_proc_address(&impl_TexCoord3sv, "glTexCoord3sv")
    set_proc_address(&impl_TexCoord4d, "glTexCoord4d")
    set_proc_address(&impl_TexCoord4dv, "glTexCoord4dv")
    set_proc_address(&impl_TexCoord4f, "glTexCoord4f")
    set_proc_address(&impl_TexCoord4fv, "glTexCoord4fv")
    set_proc_address(&impl_TexCoord4i, "glTexCoord4i")
    set_proc_address(&impl_TexCoord4iv, "glTexCoord4iv")
    set_proc_address(&impl_TexCoord4s, "glTexCoord4s")
    set_proc_address(&impl_TexCoord4sv, "glTexCoord4sv")
    set_proc_address(&impl_Vertex2d, "glVertex2d")
    set_proc_address(&impl_Vertex2dv, "glVertex2dv")
    set_proc_address(&impl_Vertex2f, "glVertex2f")
    set_proc_address(&impl_Vertex2fv, "glVertex2fv")
    set_proc_address(&impl_Vertex2i, "glVertex2i")
    set_proc_address(&impl_Vertex2iv, "glVertex2iv")
    set_proc_address(&impl_Vertex2s, "glVertex2s")
    set_proc_address(&impl_Vertex2sv, "glVertex2sv")
    set_proc_address(&impl_Vertex3d, "glVertex3d")
    set_proc_address(&impl_Vertex3dv, "glVertex3dv")
    set_proc_address(&impl_Vertex3f, "glVertex3f")
    set_proc_address(&impl_Vertex3fv, "glVertex3fv")
    set_proc_address(&impl_Vertex3i, "glVertex3i")
    set_proc_address(&impl_Vertex3iv, "glVertex3iv")
    set_proc_address(&impl_Vertex3s, "glVertex3s")
    set_proc_address(&impl_Vertex3sv, "glVertex3sv")
    set_proc_address(&impl_Vertex4d, "glVertex4d")
    set_proc_address(&impl_Vertex4dv, "glVertex4dv")
    set_proc_address(&impl_Vertex4f, "glVertex4f")
    set_proc_address(&impl_Vertex4fv, "glVertex4fv")
    set_proc_address(&impl_Vertex4i, "glVertex4i")
    set_proc_address(&impl_Vertex4iv, "glVertex4iv")
    set_proc_address(&impl_Vertex4s, "glVertex4s")
    set_proc_address(&impl_Vertex4sv, "glVertex4sv")
    set_proc_address(&impl_ClipPlane, "glClipPlane")
    set_proc_address(&impl_ColorMaterial, "glColorMaterial")
    set_proc_address(&impl_Fogf, "glFogf")
    set_proc_address(&impl_Fogfv, "glFogfv")
    set_proc_address(&impl_Fogi, "glFogi")
    set_proc_address(&impl_Fogiv, "glFogiv")
    set_proc_address(&impl_Lightf, "glLightf")
    set_proc_address(&impl_Lightfv, "glLightfv")
    set_proc_address(&impl_Lighti, "glLighti")
    set_proc_address(&impl_Lightiv, "glLightiv")
    set_proc_address(&impl_LightModelf, "glLightModelf")
    set_proc_address(&impl_LightModelfv, "glLightModelfv")
    set_proc_address(&impl_LightModeli, "glLightModeli")
    set_proc_address(&impl_LightModeliv, "glLightModeliv")
    set_proc_address(&impl_LineStipple, "glLineStipple")
    set_proc_address(&impl_Materialf, "glMaterialf")
    set_proc_address(&impl_Materialfv, "glMaterialfv")
    set_proc_address(&impl_Materiali, "glMateriali")
    set_proc_address(&impl_Materialiv, "glMaterialiv")
    set_proc_address(&impl_PolygonStipple, "glPolygonStipple")
    set_proc_address(&impl_ShadeModel, "glShadeModel")
    set_proc_address(&impl_TexEnvf, "glTexEnvf")
    set_proc_address(&impl_TexEnvfv, "glTexEnvfv")
    set_proc_address(&impl_TexEnvi, "glTexEnvi")
    set_proc_address(&impl_TexEnviv, "glTexEnviv")
    set_proc_address(&impl_TexGend, "glTexGend")
    set_proc_address(&impl_TexGendv, "glTexGendv")
    set_proc_address(&impl_TexGenf, "glTexGenf")
    set_proc_address(&impl_TexGenfv, "glTexGenfv")
    set_proc_address(&impl_TexGeni, "glTexGeni")
    set_proc_address(&impl_TexGeniv, "glTexGeniv")
    set_proc_address(&impl_FeedbackBuffer, "glFeedbackBuffer")
    set_proc_address(&impl_SelectBuffer, "glSelectBuffer")
    set_proc_address(&impl_RenderMode, "glRenderMode")
    set_proc_address(&impl_InitNames, "glInitNames")
    set_proc_address(&impl_LoadName, "glLoadName")
    set_proc_address(&impl_PassThrough, "glPassThrough")
    set_proc_address(&impl_PopName, "glPopName")
    set_proc_address(&impl_PushName, "glPushName")
    set_proc_address(&impl_ClearAccum, "glClearAccum")
    set_proc_address(&impl_ClearIndex, "glClearIndex")
    set_proc_address(&impl_IndexMask, "glIndexMask")
    set_proc_address(&impl_Accum, "glAccum")
    set_proc_address(&impl_PopAttrib, "glPopAttrib")
    set_proc_address(&impl_PushAttrib, "glPushAttrib")
    set_proc_address(&impl_Map1d, "glMap1d")
    set_proc_address(&impl_Map1f, "glMap1f")
    set_proc_address(&impl_Map2d, "glMap2d")
    set_proc_address(&impl_Map2f, "glMap2f")
    set_proc_address(&impl_MapGrid1d, "glMapGrid1d")
    set_proc_address(&impl_MapGrid1f, "glMapGrid1f")
    set_proc_address(&impl_MapGrid2d, "glMapGrid2d")
    set_proc_address(&impl_MapGrid2f, "glMapGrid2f")
    set_proc_address(&impl_EvalCoord1d, "glEvalCoord1d")
    set_proc_address(&impl_EvalCoord1dv, "glEvalCoord1dv")
    set_proc_address(&impl_EvalCoord1f, "glEvalCoord1f")
    set_proc_address(&impl_EvalCoord1fv, "glEvalCoord1fv")
    set_proc_address(&impl_EvalCoord2d, "glEvalCoord2d")
    set_proc_address(&impl_EvalCoord2dv, "glEvalCoord2dv")
    set_proc_address(&impl_EvalCoord2f, "glEvalCoord2f")
    set_proc_address(&impl_EvalCoord2fv, "glEvalCoord2fv")
    set_proc_address(&impl_EvalMesh1, "glEvalMesh1")
    set_proc_address(&impl_EvalPoint1, "glEvalPoint1")
    set_proc_address(&impl_EvalMesh2, "glEvalMesh2")
    set_proc_address(&impl_EvalPoint2, "glEvalPoint2")
    set_proc_address(&impl_AlphaFunc, "glAlphaFunc")
    set_proc_address(&impl_PixelZoom, "glPixelZoom")
    set_proc_address(&impl_PixelTransferf, "glPixelTransferf")
    set_proc_address(&impl_PixelTransferi, "glPixelTransferi")
    set_proc_address(&impl_PixelMapfv, "glPixelMapfv")
    set_proc_address(&impl_PixelMapuiv, "glPixelMapuiv")
    set_proc_address(&impl_PixelMapusv, "glPixelMapusv")
    set_proc_address(&impl_CopyPixels, "glCopyPixels")
    set_proc_address(&impl_DrawPixels, "glDrawPixels")
    set_proc_address(&impl_GetClipPlane, "glGetClipPlane")
    set_proc_address(&impl_GetLightfv, "glGetLightfv")
    set_proc_address(&impl_GetLightiv, "glGetLightiv")
    set_proc_address(&impl_GetMapdv, "glGetMapdv")
    set_proc_address(&impl_GetMapfv, "glGetMapfv")
    set_proc_address(&impl_GetMapiv, "glGetMapiv")
    set_proc_address(&impl_GetMaterialfv, "glGetMaterialfv")
    set_proc_address(&impl_GetMaterialiv, "glGetMaterialiv")
    set_proc_address(&impl_GetPixelMapfv, "glGetPixelMapfv")
    set_proc_address(&impl_GetPixelMapuiv, "glGetPixelMapuiv")
    set_proc_address(&impl_GetPixelMapusv, "glGetPixelMapusv")
    set_proc_address(&impl_GetPolygonStipple, "glGetPolygonStipple")
    set_proc_address(&impl_GetTexEnvfv, "glGetTexEnvfv")
    set_proc_address(&impl_GetTexEnviv, "glGetTexEnviv")
    set_proc_address(&impl_GetTexGendv, "glGetTexGendv")
    set_proc_address(&impl_GetTexGenfv, "glGetTexGenfv")
    set_proc_address(&impl_GetTexGeniv, "glGetTexGeniv")
    set_proc_address(&impl_IsList, "glIsList")
    set_proc_address(&impl_Frustum, "glFrustum")
    set_proc_address(&impl_LoadIdentity, "glLoadIdentity")
    set_proc_address(&impl_LoadMatrixf, "glLoadMatrixf")
    set_proc_address(&impl_LoadMatrixd, "glLoadMatrixd")
    set_proc_address(&impl_MatrixMode, "glMatrixMode")
    set_proc_address(&impl_MultMatrixf, "glMultMatrixf")
    set_proc_address(&impl_MultMatrixd, "glMultMatrixd")
    set_proc_address(&impl_Ortho, "glOrtho")
    set_proc_address(&impl_PopMatrix, "glPopMatrix")
    set_proc_address(&impl_PushMatrix, "glPushMatrix")
    set_proc_address(&impl_Rotated, "glRotated")
    set_proc_address(&impl_Rotatef, "glRotatef")
    set_proc_address(&impl_Scaled, "glScaled")
    set_proc_address(&impl_Scalef, "glScalef")
    set_proc_address(&impl_Translated, "glTranslated")
    set_proc_address(&impl_Translatef, "glTranslatef")
    // GL_VERSION_1_1
    ...
    set_proc_address(&impl_ArrayElement, "glArrayElement")
    set_proc_address(&impl_ColorPointer, "glColorPointer")
    set_proc_address(&impl_DisableClientState, "glDisableClientState")
    set_proc_address(&impl_EdgeFlagPointer, "glEdgeFlagPointer")
    set_proc_address(&impl_EnableClientState, "glEnableClientState")
    set_proc_address(&impl_IndexPointer, "glIndexPointer")
    set_proc_address(&impl_InterleavedArrays, "glInterleavedArrays")
    set_proc_address(&impl_NormalPointer, "glNormalPointer")
    set_proc_address(&impl_TexCoordPointer, "glTexCoordPointer")
    set_proc_address(&impl_VertexPointer, "glVertexPointer")
    set_proc_address(&impl_AreTexturesResident, "glAreTexturesResident")
    set_proc_address(&impl_PrioritizeTextures, "glPrioritizeTextures")
    set_proc_address(&impl_Indexub, "glIndexub")
    set_proc_address(&impl_Indexubv, "glIndexubv")
    set_proc_address(&impl_PopClientAttrib, "glPopClientAttrib")
    set_proc_address(&impl_PushClientAttrib, "glPushClientAttrib")
    // GL_VERSION_1_2
    ...
    set_proc_address(&impl_ClientActiveTexture, "glClientActiveTexture")
    set_proc_address(&impl_MultiTexCoord1d, "glMultiTexCoord1d")
    set_proc_address(&impl_MultiTexCoord1dv, "glMultiTexCoord1dv")
    set_proc_address(&impl_MultiTexCoord1f, "glMultiTexCoord1f")
    set_proc_address(&impl_MultiTexCoord1fv, "glMultiTexCoord1fv")
    set_proc_address(&impl_MultiTexCoord1i, "glMultiTexCoord1i")
    set_proc_address(&impl_MultiTexCoord1iv, "glMultiTexCoord1iv")
    set_proc_address(&impl_MultiTexCoord1s, "glMultiTexCoord1s")
    set_proc_address(&impl_MultiTexCoord1sv, "glMultiTexCoord1sv")
    set_proc_address(&impl_MultiTexCoord2d, "glMultiTexCoord2d")
    set_proc_address(&impl_MultiTexCoord2dv, "glMultiTexCoord2dv")
    set_proc_address(&impl_MultiTexCoord2f, "glMultiTexCoord2f")
    set_proc_address(&impl_MultiTexCoord2fv, "glMultiTexCoord2fv")
    set_proc_address(&impl_MultiTexCoord2i, "glMultiTexCoord2i")
    set_proc_address(&impl_MultiTexCoord2iv, "glMultiTexCoord2iv")
    set_proc_address(&impl_MultiTexCoord2s, "glMultiTexCoord2s")
    set_proc_address(&impl_MultiTexCoord2sv, "glMultiTexCoord2sv")
    set_proc_address(&impl_MultiTexCoord3d, "glMultiTexCoord3d")
    set_proc_address(&impl_MultiTexCoord3dv, "glMultiTexCoord3dv")
    set_proc_address(&impl_MultiTexCoord3f, "glMultiTexCoord3f")
    set_proc_address(&impl_MultiTexCoord3fv, "glMultiTexCoord3fv")
    set_proc_address(&impl_MultiTexCoord3i, "glMultiTexCoord3i")
    set_proc_address(&impl_MultiTexCoord3iv, "glMultiTexCoord3iv")
    set_proc_address(&impl_MultiTexCoord3s, "glMultiTexCoord3s")
    set_proc_address(&impl_MultiTexCoord3sv, "glMultiTexCoord3sv")
    set_proc_address(&impl_MultiTexCoord4d, "glMultiTexCoord4d")
    set_proc_address(&impl_MultiTexCoord4dv, "glMultiTexCoord4dv")
    set_proc_address(&impl_MultiTexCoord4f, "glMultiTexCoord4f")
    set_proc_address(&impl_MultiTexCoord4fv, "glMultiTexCoord4fv")
    set_proc_address(&impl_MultiTexCoord4i, "glMultiTexCoord4i")
    set_proc_address(&impl_MultiTexCoord4iv, "glMultiTexCoord4iv")
    set_proc_address(&impl_MultiTexCoord4s, "glMultiTexCoord4s")
    set_proc_address(&impl_MultiTexCoord4sv, "glMultiTexCoord4sv")
    set_proc_address(&impl_LoadTransposeMatrixf, "glLoadTransposeMatrixf")
    set_proc_address(&impl_LoadTransposeMatrixd, "glLoadTransposeMatrixd")
    set_proc_address(&impl_MultTransposeMatrixf, "glMultTransposeMatrixf")
    set_proc_address(&impl_MultTransposeMatrixd, "glMultTransposeMatrixd")
    // GL_VERSION_1_4
    ...
    set_proc_address(&impl_FogCoordf, "glFogCoordf")
    set_proc_address(&impl_FogCoordfv, "glFogCoordfv")
    set_proc_address(&impl_FogCoordd, "glFogCoordd")
    set_proc_address(&impl_FogCoorddv, "glFogCoorddv")
    set_proc_address(&impl_FogCoordPointer, "glFogCoordPointer")
    set_proc_address(&impl_SecondaryColor3b, "glSecondaryColor3b")
    set_proc_address(&impl_SecondaryColor3bv, "glSecondaryColor3bv")
    set_proc_address(&impl_SecondaryColor3d, "glSecondaryColor3d")
    set_proc_address(&impl_SecondaryColor3dv, "glSecondaryColor3dv")
    set_proc_address(&impl_SecondaryColor3f, "glSecondaryColor3f")
    set_proc_address(&impl_SecondaryColor3fv, "glSecondaryColor3fv")
    set_proc_address(&impl_SecondaryColor3i, "glSecondaryColor3i")
    set_proc_address(&impl_SecondaryColor3iv, "glSecondaryColor3iv")
    set_proc_address(&impl_SecondaryColor3s, "glSecondaryColor3s")
    set_proc_address(&impl_SecondaryColor3sv, "glSecondaryColor3sv")
    set_proc_address(&impl_SecondaryColor3ub, "glSecondaryColor3ub")
    set_proc_address(&impl_SecondaryColor3ubv, "glSecondaryColor3ubv")
    set_proc_address(&impl_SecondaryColor3ui, "glSecondaryColor3ui")
    set_proc_address(&impl_SecondaryColor3uiv, "glSecondaryColor3uiv")
    set_proc_address(&impl_SecondaryColor3us, "glSecondaryColor3us")
    set_proc_address(&impl_SecondaryColor3usv, "glSecondaryColor3usv")
    set_proc_address(&impl_SecondaryColorPointer, "glSecondaryColorPointer")
    set_proc_address(&impl_WindowPos2d, "glWindowPos2d")
    set_proc_address(&impl_WindowPos2dv, "glWindowPos2dv")
    set_proc_address(&impl_WindowPos2f, "glWindowPos2f")
    set_proc_address(&impl_WindowPos2fv, "glWindowPos2fv")
    set_proc_address(&impl_WindowPos2i, "glWindowPos2i")
    set_proc_address(&impl_WindowPos2iv, "glWindowPos2iv")
    set_proc_address(&impl_WindowPos2s, "glWindowPos2s")
    set_proc_address(&impl_WindowPos2sv, "glWindowPos2sv")
    set_proc_address(&impl_WindowPos3d, "glWindowPos3d")
    set_proc_address(&impl_WindowPos3dv, "glWindowPos3dv")
    set_proc_address(&impl_WindowPos3f, "glWindowPos3f")
    set_proc_address(&impl_WindowPos3fv, "glWindowPos3fv")
    set_proc_address(&impl_WindowPos3i, "glWindowPos3i")
    set_proc_address(&impl_WindowPos3iv, "glWindowPos3iv")
    set_proc_address(&impl_WindowPos3s, "glWindowPos3s")
    set_proc_address(&impl_WindowPos3sv, "glWindowPos3sv")
